...
from ...operations._snapshots_operations import build_create_or_update_request, build_delete_request, build_get_request, build_grant_access_request, build_list_by_resource_group_request, build_list_request, build_revoke_access_request, build_update_request
T = TypeVar('T')
...
class SnapshotsOperations:
    ...
    async def _create_or_update_initial(
        ...
        snapshot_name: str,
        snapshot: Union[_models.Snapshot, IO],
        **kwargs: Any
    ) -> _models.Snapshot:
        error_map = {
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        snapshot_name: str,
        snapshot: Union[_models.SnapshotUpdate, IO],
        **kwargs: Any
    ) -> _models.Snapshot:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
