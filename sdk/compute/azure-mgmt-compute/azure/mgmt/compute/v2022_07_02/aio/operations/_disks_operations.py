...
from ...operations._disks_operations import build_create_or_update_request, build_delete_request, build_get_request, build_grant_access_request, build_list_by_resource_group_request, build_list_request, build_revoke_access_request, build_update_request
T = TypeVar('T')
...
class DisksOperations:
    ...
    async def _update_initial(
        ...
        resource_group_name: str,
        disk_name: str,
        disk: Union[_models.DiskUpdate, IO],
        **kwargs: Any
    ) -> _models.Disk:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
