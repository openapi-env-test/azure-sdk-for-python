...
class OSDiskImageSecurityProfile(_serialization.Model):
    ...
    :ivar secure_v_mdisk_encryption_set_id: secure VM disk encryption set id.
    :vartype secure_v_mdisk_encryption_set_id: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword secure_v_mdisk_encryption_set_id: secure VM disk encryption set id.
        :paramtype secure_v_mdisk_encryption_set_id: str
        """
        super().__init__(**kwargs)
        self.type = type
