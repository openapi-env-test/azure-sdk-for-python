...
from ...operations._availability_sets_operations import build_delete_request, build_get_request, build_list_available_sizes_request, build_list_by_subscription_request, build_list_request, build_update_request
T = TypeVar('T')
