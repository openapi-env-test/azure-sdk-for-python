...
class AvailabilitySetsOperations:
    ...
    async def create_or_update_a(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self.create_or_update_a.metadata['url']  # type: ignore
        ...
        return deserialized
    create_or_update_a.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/availabilitySets/{availabilitySetName}'}  # type: ignore
