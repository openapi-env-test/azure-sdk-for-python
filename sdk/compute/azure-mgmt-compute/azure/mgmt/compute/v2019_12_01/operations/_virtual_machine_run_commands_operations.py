...
class VirtualMachineRunCommandsOperations(object):
    ...
    def create_or_update(
        ...
        :type run_command:
         ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommand
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommand]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommand]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
    ...
    def update(
        ...
        :param run_command: Parameters supplied to the Update Virtual Machine
         RunCommand operation.
        :type run_command:
         ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommandUpdate
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def get_by_virtual_machine(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommand or
         ~msrest.pipeline.ClientRawResponse
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        # Construct URL
    ...
    def list_by_virtual_machine(
        ...
        :rtype:
         ~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommandPaged[~azure.mgmt.compute.v2019_12_01.models.VirtualMachineRunCommand]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        def prepare_request(next_link=None):
            if not next_link:
