...
class HostPoolsOperations:
    ...
    @distributed_trace
    def list_by_resource_group(self, resource_group_name: str, **kwargs: Any) -> AsyncIterable["_models.HostPool"]:
        """List hostPools.
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> AsyncIterable["_models.HostPool"]:
