...
class ProductsOperations(object):
    ...
    def list_by_customer(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of ProductsListResult or the result of cls(response)
    ...
    def move(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.TransferProductRequestProperties(destination_invoice_section_id=destination_invoice_section_id)
        api_version = "2020-05-01"
    ...
    def update_auto_renew(
        ...
        billing_account_name,  # type: str
        product_name,  # type: str
        auto_renew=None,  # type: Optional[Union[str, "models.UpdateAutoRenew"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.UpdateAutoRenewOperation"
        ...
        :param product_name: The ID that uniquely identifies a product.
        :type product_name: str
        :param auto_renew: The flag that determines the auto-renew settings for a product.
        :type auto_renew: str or ~azure.mgmt.billing.models.UpdateAutoRenew
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: UpdateAutoRenewOperation or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.UpdateAutoRenewOperation
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.UpdateAutoRenewOperation"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))

        _body = models.UpdateAutoRenewRequest(auto_renew=auto_renew)
        api_version = "2020-05-01"
        content_type = kwargs.pop("content_type", "application/json")

        # Construct URL
        url = self.update_auto_renew.metadata['url']  # type: ignore
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
            'productName': self._serialize.url("product_name", product_name, 'str'),
        }
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_body, 'UpdateAutoRenewRequest')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
        ...
        deserialized = self._deserialize('UpdateAutoRenewOperation', pipeline_response)

        if cls:
          return cls(pipeline_response, deserialized, {})

        return deserialized
    update_auto_renew.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/products/{productName}/updateAutoRenew'}  # type: ignore
