...
class BillingSubscriptionsOperations(object):
    ...
    def list_by_customer(
        ...
        **kwargs  # type: Any
        ...
        :return: An iterator like instance of BillingSubscriptionsListResult or the result of cls(response)
    ...
    def get(
        self,
        billing_account_name,  # type: str
        billing_subscription_name,  # type: str
        **kwargs  # type: Any
    ):
        ...
        :param billing_account_name: The ID that uniquely identifies a billing account.
        :type billing_account_name: str
        :param billing_subscription_name: The ID that uniquely identifies a subscription.
        ...
        return deserialized
    get.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}'}  # type: ignore
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    update.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}'}  # type: ignore
    ...
    def _move_initial(
        ...
        **kwargs  # type: Any
        ...
        _parameters = models.TransferBillingSubscriptionRequestProperties(destination_invoice_section_id=destination_invoice_section_id)
        content_type = kwargs.pop("content_type", "application/json")
        ...
        return deserialized
    _move_initial.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}/move'}  # type: ignore
    ...
    def begin_move(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns BillingSubscription
    ...
    begin_move.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}/move'}  # type: ignore
    ...
    def validate_move(
        ...
        **kwargs  # type: Any
        ...
        return deserialized
    validate_move.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingSubscriptions/{billingSubscriptionName}/validateMoveEligibility'}  # type: ignore
