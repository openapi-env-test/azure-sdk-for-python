...
class BillingAccount(Resource):
    ...
    def __init__(
        ...
        *,
        ...
        billing_profiles: Optional[List["BillingProfile"]] = None,
...
class BillingProfile(Resource):
    ...
    :param invoice_sections: The invoice sections associated to the billing profile.
    ...
    def __init__(
        ...
        *,
        ...
        invoice_sections: Optional[List["InvoiceSection"]] = None,
        **kwargs
    ):
...
class BillingRoleAssignment(Resource):
    ...
    :ivar name_properties_name: The name of the role assignment.
...
class BillingRoleAssignmentPayload(msrest.serialization.Model):
...
class DepartmentListResult(msrest.serialization.Model):
...
class UpdateAutoRenewOperation(msrest.serialization.Model):
...
class UpdateAutoRenewRequest(msrest.serialization.Model):
    """Request parameters to update auto renew settings for a product.

    :param auto_renew: The flag that determines the auto-renew settings for a product. Possible
    ...
    def __init__(
        self,
        *,
        auto_renew: Optional[Union[str, "UpdateAutoRenew"]] = None,
        **kwargs
    ):
