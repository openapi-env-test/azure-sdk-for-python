...
try:
    ...
    from ._models import BillingRoleAssignmentPayload  # type: ignore
    ...
    from ._models import DepartmentListResult  # type: ignore
    ...
    from ._models import UpdateAutoRenewOperation  # type: ignore
    from ._models import UpdateAutoRenewRequest  # type: ignore
