...
class InvoiceSectionsOperations:
    ...
    def list_by_billing_profile(
        ...
        **kwargs
        ...
        :return: An iterator like instance of InvoiceSectionListResult or the result of cls(response)
    ...
    async def _create_or_update_initial(
        ...
        **kwargs
        ...
        _parameters = models.InvoiceSection(display_name=display_name, labels=labels)
        api_version = "2020-05-01"
    ...
    create_or_update.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}'}  # type: ignore
