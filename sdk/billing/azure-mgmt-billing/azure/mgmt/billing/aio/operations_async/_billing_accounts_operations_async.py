...
class BillingAccountsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of BillingAccountListResult or the result of cls(response)
    ...
    update.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}'}  # type: ignore
    ...
    def list_invoice_sections_by_create_subscription_permission(
        ...
        **kwargs
        ...
        :type billing_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of InvoiceSectionListWithCreateSubPermissionResult or the result of cls(response)
