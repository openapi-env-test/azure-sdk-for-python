...
class BillingRoleAssignmentsOperations:
    ...
    def list_by_billing_account(
        ...
        **kwargs
        ...
        :type billing_account_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of BillingRoleAssignmentListResult or the result of cls(response)
    ...
    async def add_by_billing_account(
        self,
        billing_account_name: str,
        principal_id: Optional[str] = None,
        role_definition_id: Optional[str] = None,
        **kwargs
    ) -> "models.BillingRoleAssignmentListResult":
        ...
        :param billing_account_name: The ID that uniquely identifies a billing account.
        :type billing_account_name: str
        :param principal_id: The user's principal id that the role gets assigned to.
        :type principal_id: str
        :param role_definition_id: The role definition id.
        :type role_definition_id: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: BillingRoleAssignmentListResult or the result of cls(response)
        :rtype: ~azure.mgmt.billing.models.BillingRoleAssignmentListResult
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BillingRoleAssignmentListResult"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        ...
        _parameters = models.BillingRoleAssignmentPayload(principal_id=principal_id, role_definition_id=role_definition_id)
        api_version = "2020-05-01"
        content_type = kwargs.pop("content_type", "application/json")

        # Construct URL
        url = self.add_by_billing_account.metadata['url']  # type: ignore
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        body_content = self._serialize.body(_parameters, 'BillingRoleAssignmentPayload')
        ...
        return deserialized
    add_by_billing_account.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/createBillingRoleAssignment'}  # type: ignore
    ...
    async def add_by_invoice_section(
        self,
        billing_account_name: str,
        billing_profile_name: str,
        invoice_section_name: str,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.add_by_invoice_section.metadata['url']  # type: ignore
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
            'billingProfileName': self._serialize.url("billing_profile_name", billing_profile_name, 'str'),
            'invoiceSectionName': self._serialize.url("invoice_section_name", invoice_section_name, 'str'),
        ...
        return deserialized
    add_by_invoice_section.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/invoiceSections/{invoiceSectionName}/createBillingRoleAssignment'}  # type: ignore
    ...
    async def add_by_billing_profile(
        self,
        billing_account_name: str,
        billing_profile_name: str,
        principal_id: Optional[str] = None,
        ...
        **kwargs
        ...
        # Construct URL
        url = self.add_by_billing_profile.metadata['url']  # type: ignore
        path_format_arguments = {
            'billingAccountName': self._serialize.url("billing_account_name", billing_account_name, 'str'),
            'billingProfileName': self._serialize.url("billing_profile_name", billing_profile_name, 'str'),
        }
        ...
        return deserialized
    add_by_billing_profile.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/createBillingRoleAssignment'}  # type: ignore
