...
class BillingProfilesOperations:
    ...
    def list_by_billing_account(
        ...
        **kwargs
        ...
        :return: An iterator like instance of BillingProfileListResult or the result of cls(response)
    ...
    create_or_update.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}'}  # type: ignore
