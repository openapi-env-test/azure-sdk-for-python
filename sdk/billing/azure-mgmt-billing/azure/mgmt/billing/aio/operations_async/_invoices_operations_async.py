...
class InvoicesOperations:
    ...
    def list_by_billing_account(
     ...
     DD-YYYY format.
        ...
        :return: An iterator like instance of InvoiceListResult or the result of cls(response)
    ...
    async def download_invoice(
        ...
        **kwargs
        ...
        :return: DownloadUrl
        :rtype: ~azure.mgmt.billing.models.DownloadUrl
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    download_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoices/{invoiceName}/download'}  # type: ignore
    ...
    async def download_billing_subscription_invoice(
        self,
        invoice_name: str,
        download_token: str,
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    download_billing_subscription_invoice.metadata = {'url': '/providers/Microsoft.Billing/billingAccounts/default/billingSubscriptions/{subscriptionId}/invoices/{invoiceName}/download'}  # type: ignore
