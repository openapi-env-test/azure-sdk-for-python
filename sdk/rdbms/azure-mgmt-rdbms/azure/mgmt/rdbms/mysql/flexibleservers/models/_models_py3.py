...
class MaintenanceWindow(ProxyResource):
    ...
    :ivar type: The type of the resource. Ex-
     Microsoft.Compute/virtualMachines or Microsoft.Storage/storageAccounts.
    :vartype type: str
    :param day_of_week: Required. The day of week of the maintenance window to
     start
    :type day_of_week: int
    :param duration_in_minutes: The duration of the maintenance window to run.
    :type duration_in_minutes: int
    :param start_hour: Required. The starting hour of the maintenance window.
    :type start_hour: int
    :param start_minute: Required. The starting minutes of the maintenance
     window.
...
class Sku(Model):
    ...
    :param name: The name of the sku, e.g. Standard_D32s_v3.
    :type name: str
    :param tier: The tier of the particular SKU, e.g. GeneralPurpose. Possible
    ...
    def __init__(self, *, name: str=None, tier=None, **kwargs) -> None:
...
class Server(TrackedResource):
    ...
    :param vnet_inj_args: Vnet arguments.
    :type vnet_inj_args:
     ~azure.mgmt.rdbms.mysql.flexibleservers.models.VnetInjArgs
    ...
    _attribute_map = {
        ...
        'vnet_inj_args': {'key': 'properties.vnetInjArgs', 'type': 'VnetInjArgs'},
        'create_mode': {'key': 'properties.createMode', 'type': 'str'},
        'server_tags': {'key': 'properties.tags', 'type': '{str}'},
    }

    def __init__(self, *, location: str, tags=None, identity=None, sku=None, administrator_login: str=None, administrator_login_password: str=None, version=None, ssl_enforcement=None, infrastructure_encryption=None, standby_count: int=None, earliest_restore_date=None, storage_profile=None, replication_role: str=None, replica_capacity: int=None, public_network_access=None, source_server_id: str=None, restore_point_in_time=None, vnet_inj_args=None, create_mode=None, server_tags=None, **kwargs) -> None:
...
class ServerForUpdate(Model):
    ...
    def __init__(self, *, sku=None, storage_profile=None, administrator_login_password: str=None, ssl_enforcement=None, vnet_inj_args=None, standby_count: int=None, public_network_access=None, replication_role: str=None, tags=None, **kwargs) -> None:
...
class VnetInjArgs(Model):
    ...
    def __init__(self, *, delegated_vnet_id: str=None, delegated_subnet_name: str=None, delegated_vnet_name: str=None, **kwargs) -> None:
        super(VnetInjArgs, self).__init__(**kwargs)
