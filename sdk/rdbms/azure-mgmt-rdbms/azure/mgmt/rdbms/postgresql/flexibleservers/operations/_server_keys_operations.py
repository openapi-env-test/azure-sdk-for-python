...
class ServerKeysOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerKeyPaged[~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerKey]
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerKey
    ...
    def create_or_update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerKey]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.postgresql.flexibleservers.models.ServerKey]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
