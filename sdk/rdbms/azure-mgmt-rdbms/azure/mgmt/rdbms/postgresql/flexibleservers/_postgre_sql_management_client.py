...
from .operations import PostgreSQLManagementClientOperationsMixin
...
from .operations import CustomerMaintenanceWindowOperations
...
class PostgreSQLManagementClient(PostgreSQLManagementClientOperationsMixin, SDKClient):
    ...
    :ivar customer_maintenance_window: CustomerMaintenanceWindow operations
    :vartype customer_maintenance_window: azure.mgmt.rdbms.postgresql.flexibleservers.operations.CustomerMaintenanceWindowOperations
    ...
    def __init__(
        ...
        self.configurations = ConfigurationsOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.customer_maintenance_window = CustomerMaintenanceWindowOperations(
            self._client, self.config, self._serialize, self._deserialize)
