...
class Server(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, identity=None, sku=None, administrator_login: str=None, administrator_login_password: str=None, version=None, display_name: str=None, storage_profile=None, standby_count: int=None, source_server_name: str=None, point_in_time_utc=None, availability_zone: str=None, delegated_subnet_arguments=None, create_mode=None, server_tags=None, **kwargs) -> None:
...
class ServerForUpdate(Model):
    ...
    def __init__(self, *, location: str=None, sku=None, administrator_login_password: str=None, storage_profile=None, standby_count: int=None, tags=None, **kwargs) -> None:
