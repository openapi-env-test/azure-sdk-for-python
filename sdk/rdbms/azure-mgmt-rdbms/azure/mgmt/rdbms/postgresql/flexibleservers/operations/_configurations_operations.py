...
class ConfigurationsOperations(object):
    ...
    def update(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.rdbms.postgresql.flexibleservers.models.Configuration]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.rdbms.postgresql.flexibleservers.models.Configuration]]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
