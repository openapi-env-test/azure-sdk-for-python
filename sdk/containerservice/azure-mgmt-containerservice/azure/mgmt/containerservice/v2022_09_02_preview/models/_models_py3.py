...
class FleetHubProfile(_serialization.Model):
    ...
    _validation = {
        'dns_prefix': {'max_length': 54, 'min_length': 1, 'pattern': r'^[a-zA-Z0-9]$|^[a-zA-Z0-9][a-zA-Z0-9-]{0,52}[a-zA-Z0-9]$'},
        'fqdn': {'readonly': True},
