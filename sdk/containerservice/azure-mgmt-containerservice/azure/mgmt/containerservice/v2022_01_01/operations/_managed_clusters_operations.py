...
def build_create_or_update_request(
    ...
    subscription_id: str,
    *,
    akshttp_custom_features: Optional[List[str]] = None,
    **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct headers
    if akshttp_custom_features is not None:
        _headers["AKSHTTPCustomFeatures"] = _SERIALIZER.header(
            "akshttp_custom_features", akshttp_custom_features, "[str]", div=","
        )
...
class ManagedClustersOperations:  # pylint: disable=too-many-public-methods
    ...
    def _create_or_update_initial(
        ...
        **kwargs: Any
        ...
        request = build_create_or_update_request(
            ...
            resource_name=resource_name,
            subscription_id=self._config.subscription_id,
            akshttp_custom_features=akshttp_custom_features,
            api_version=api_version,
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :param akshttp_custom_features: A list of Custom Features which should be enabled on this AKS
         Cluster. Default value is None.
        :type akshttp_custom_features: list[str]
