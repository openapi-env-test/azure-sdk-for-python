...
class InstancesOperations:
    ...
    def list_by_account(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~device_update.models.Instance]
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :type instance: ~device_update.models.Instance or IO
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        :type tag_update_payload: ~device_update.models.TagUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
