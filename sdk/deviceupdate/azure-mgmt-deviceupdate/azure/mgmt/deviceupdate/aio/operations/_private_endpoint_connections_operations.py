...
class PrivateEndpointConnectionsOperations:
    ...
    def list_by_account(
        ...
        :return: An iterator like instance of either PrivateEndpointConnection or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~device_update.models.PrivateEndpointConnection]
    ...
    async def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection: ~device_update.models.PrivateEndpointConnection or IO
