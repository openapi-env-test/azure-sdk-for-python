...
class AccountsOperations:
    ...
    def list_by_subscription(self, **kwargs: Any) -> Iterable["_models.Account"]:
        ...
        :rtype: ~azure.core.paging.ItemPaged[~device_update.models.Account]
    ...
    def begin_create(
        ...
        :type account: ~device_update.models.Account or IO
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type account_update_payload: ~device_update.models.AccountUpdate or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
