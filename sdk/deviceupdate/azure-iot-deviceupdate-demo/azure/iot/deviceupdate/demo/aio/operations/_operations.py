...
class DeviceUpdateOperations:
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~azure.iot.deviceupdate.demo.aio.DeviceUpdateClient`'s
...
class DeviceManagementOperations:  # pylint: disable=too-many-public-methods
    ...
    async def update_device_class(
        self,
        device_class_id: str,
        device_class_patch: Union[JSON, IO],
        **kwargs: Any
    ) -> JSON:
        """Update device class details.
