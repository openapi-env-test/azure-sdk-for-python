...
class DeviceUpdateClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype device_update: azure.iot.deviceupdate.demo.aio.operations.DeviceUpdateOperations
    :ivar device_management: DeviceManagementOperations operations
    :vartype device_management:
     azure.iot.deviceupdate.demo.aio.operations.DeviceManagementOperations
