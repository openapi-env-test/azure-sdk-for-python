...
from ...operations._device_management_operations import build_collect_logs_request, build_create_or_update_deployment_request, build_create_or_update_group_request, build_delete_deployment_request, build_delete_group_request, build_get_deployment_request, build_get_deployment_status_request, build_get_device_class_request, build_get_device_module_request, build_get_device_request, build_get_device_tag_request, build_get_group_request, build_get_group_update_compliance_request, build_get_log_collection_operation_detailed_status_request, build_get_log_collection_operation_request, build_get_operation_request, build_get_update_compliance_request, build_import_devices_request_initial, build_list_best_updates_for_group_request, build_list_deployment_devices_request, build_list_deployments_for_group_request, build_list_device_classes_request, build_list_device_tags_request, build_list_devices_request, build_list_groups_request, build_list_installable_updates_for_device_class_request, build_list_log_collection_operations_request, build_list_operations_request, build_retry_deployment_request, build_stop_deployment_aaa_request
T = TypeVar('T')
...
class DeviceManagementOperations:
    ...
    def list_device_classes(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.DeviceClassesList"]:
        ...
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.DeviceClassesList]
    ...
    def list_installable_updates_for_device_class(
        ...
        device_class_id: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.UpdateIdsList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.UpdateIdsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_devices(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DevicesList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.DevicesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_device_tags(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.DeviceTagsList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.DeviceTagsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_groups(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.GroupsList"]:
        """Gets a list of all device groups.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of either GroupsList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.GroupsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_best_updates_for_group(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models.UpdatableDevicesList"]:
        ...
        :return: An iterator like instance of either UpdatableDevicesList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.UpdatableDevicesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_deployments_for_group(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models.DeploymentsList"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.DeploymentsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_deployment_devices(
        ...
        filter: Optional[str] = None,
        **kwargs: Any
    ) -> AsyncIterable["_models.DeploymentDeviceStatesList"]:
        ...
        :return: An iterator like instance of either DeploymentDeviceStatesList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.DeploymentDeviceStatesList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_operations(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DeviceOperationsList"]:
        ...
        :return: An iterator like instance of either DeviceOperationsList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.DeviceOperationsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def list_log_collection_operations(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.LogCollectionOperationList"]:
        ...
        :return: An iterator like instance of either LogCollectionOperationList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.iot.deviceupdate.models.LogCollectionOperationList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def stop_deployment_aaa(
        ...
        **kwargs: Any
        ...
        request = build_stop_deployment_aaa_request(
            instance_id=self._config.instance_id,
            group_id=group_id,
            deployment_id=deployment_id,
            action=action,
            template_url=self.stop_deployment_aaa.metadata['url'],
        )
        request = _convert_request(request)
        path_format_arguments = {
            "endpoint": self._serialize.url("self._config.endpoint", self._config.endpoint, 'str', skip_quote=True),
