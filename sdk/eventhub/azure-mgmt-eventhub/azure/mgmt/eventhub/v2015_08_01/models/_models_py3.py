...
class ConsumerGroupResource(Resource):
    ...
    def __init__(self, *, location: Optional[str] = None, user_metadata: Optional[str] = None, **kwargs):
        """
        :keyword location: Resource location.
        :paramtype location: str
        :keyword user_metadata: The user metadata.
...
class EventHubListResult(_serialization.Model):
    ...
    def __init__(
        self, *, value: Optional[List["_models.EventHubResource"]] = None, next_link: Optional[str] = None, **kwargs
    ):
        """
