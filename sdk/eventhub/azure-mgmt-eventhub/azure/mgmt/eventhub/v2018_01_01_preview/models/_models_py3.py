...
class MessagingRegionsListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.MessagingRegions"]] = None,
        **kwargs
    ):
        """
...
class Sku(msrest.serialization.Model):
    ...
    :ivar name: Required. Name of this SKU. Known values are: "Basic", "Standard".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. Name of this SKU. Known values are: "Basic", "Standard".
