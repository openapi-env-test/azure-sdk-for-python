...
class ApplicationGroupPolicy(msrest.serialization.Model):
    ...
    :vartype name: str
    :ivar type: Required. Application Group Policy types.Constant filled by server. Known values
     are: "ThrottlingPolicy".
    :vartype type: str or
...
class CaptureDescription(msrest.serialization.Model):
    ...
    :ivar encoding: Enumerates the possible values for the encoding format of capture description.
     Note: 'AvroDeflate' will be deprecated in New API Version. Known values are: "Avro",
     "AvroDeflate".
...
class ClusterSku(msrest.serialization.Model):
    ...
    :ivar name: Required. Name of this SKU. Known values are: "Dedicated".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. Name of this SKU. Known values are: "Dedicated".
...
class ConsumerGroupListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.ConsumerGroup"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
...
class EHNamespaceListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.EHNamespace"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
...
class NetworkRuleSet(ProxyResource):
    ...
    :ivar public_network_access: This determines if traffic is allowed over public network. By
     ...
     "Enabled", "Disabled", "SecuredByPerimeter". Default value: "Enabled".
    :vartype public_network_access: str or
...
class NetworkSecurityPerimeterConfiguration(TrackedResource):
    ...
    def __init__(
        ...
        *,
        location: Optional[str] = None,
        tags: Optional[Dict[str, str]] = None,
        provisioning_state: Optional[Union[str, "_models.NetworkSecurityPerimeterConfigurationProvisioningState"]] = None,
...
class NspAccessRuleProperties(msrest.serialization.Model):
    ...
    :ivar direction: Direction of Access Rule. Known values are: "Inbound", "Outbound".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword direction: Direction of Access Rule. Known values are: "Inbound", "Outbound".
...
class NWRuleSetIpRules(msrest.serialization.Model):
    ...
    :vartype ip_mask: str
    :ivar action: The IP Filter Action. Known values are: "Allow".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword action: The IP Filter Action. Known values are: "Allow".
...
class SchemaGroup(ProxyResource):
    ...
    :ivar schema_compatibility: Known values are: "None", "Backward", "Forward".
    :vartype schema_compatibility: str or
     ~azure.mgmt.eventhub.v2022_01_01_preview.models.SchemaCompatibility
    :ivar schema_type: Known values are: "Unknown", "Avro".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword schema_compatibility: Known values are: "None", "Backward", "Forward".
        :paramtype schema_compatibility: str or
         ~azure.mgmt.eventhub.v2022_01_01_preview.models.SchemaCompatibility
        :keyword schema_type: Known values are: "Unknown", "Avro".
...
class SchemaGroupListResult(msrest.serialization.Model):
    ...
    def __init__(
        self,
        *,
        value: Optional[List["_models.SchemaGroup"]] = None,
        next_link: Optional[str] = None,
        **kwargs
    ):
        """
...
class ThrottlingPolicy(ApplicationGroupPolicy):
    ...
    :ivar metric_id: Required. Metric Id on which the throttle limit should be set, MetricId can be
     ...
     Portal. Known values are: "IncomingBytes", "OutgoingBytes", "IncomingMessages",
     "OutgoingMessages".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword metric_id: Required. Metric Id on which the throttle limit should be set, MetricId can
         ...
         Azure Portal. Known values are: "IncomingBytes", "OutgoingBytes", "IncomingMessages",
         "OutgoingMessages".
