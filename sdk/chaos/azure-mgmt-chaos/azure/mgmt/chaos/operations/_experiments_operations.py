...
def build_list_all_request(subscription_id: str, *, running: Optional[bool] = None, **kwargs: Any) -> HttpRequest:
...
class ExperimentsOperations:
    ...
    @distributed_trace
    def list_all(self, running: Optional[bool] = None, **kwargs: Any) -> Iterable["_models.Experiment"]:
