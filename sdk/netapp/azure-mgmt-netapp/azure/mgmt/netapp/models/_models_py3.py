...
class ActiveDirectory(msrest.serialization.Model):
    ...
    :type username: str
    :param password: Plain text password of Active Directory domain administrator.
    :type password: str
...
class MountTarget(msrest.serialization.Model):
    ...
    :type subnet: str
    :param start_ip: The start of IPv4 address range to use when creating a new mount target.
    :type start_ip: str
    :param end_ip: The end of IPv4 address range to use when creating a new mount target.
    :type end_ip: str
    :param gateway: The gateway of the IPv4 address range to use when creating a new mount target.
    :type gateway: str
    :param netmask: The netmask of the IPv4 address range to use when creating a new mount target.
    :type netmask: str
