...
class AccountEncryption(_serialization.Model):
    ...
    def __init__(self, *, key_source: Optional[str] = None, **kwargs):
        """
...
class Vault(_serialization.Model):
    ...
    def __init__(self, *, location: str, vault_name: Optional[str] = None, **kwargs):
        """
        :keyword location: Resource location. Required.
        :paramtype location: str
...
class Volume(TrackedResource):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar encryption_key_source: Source of key used to encrypt data in volume. Possible values
     (case-insensitive) are: 'Microsoft.NetApp'. "Microsoft.NetApp"
