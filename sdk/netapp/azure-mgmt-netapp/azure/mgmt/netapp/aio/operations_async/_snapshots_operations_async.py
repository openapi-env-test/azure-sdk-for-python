...
class SnapshotsOperations:
    ...
    def list(
        ...
        volume_name: str,
        **kwargs
    ) -> AsyncIterable["models.SnapshotsList"]:
        ...
        :return: An iterator like instance of SnapshotsList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.netapp.models.SnapshotsList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SnapshotsList"]
    ...
    async def _create_initial(
        ...
        **kwargs
        ...
        _body = models.Snapshot(location=location, file_system_id=file_system_id)
        api_version = "2019-11-01"
        ...
        body_content = self._serialize.body(_body, 'Snapshot')
    ...
    async def create(
        ...
        **kwargs
        ...
        :type location: str
        :param file_system_id: UUID v4 used to identify the FileSystem.
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/snapshots/{snapshotName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/snapshots/{snapshotName}'}  # type: ignore
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}/capacityPools/{poolName}/volumes/{volumeName}/snapshots/{snapshotName}'}  # type: ignore
