...
class AccountsOperations:
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.NetAppAccountList"]:
        ...
        :return: An iterator like instance of NetAppAccountList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.netapp.models.NetAppAccountList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetAppAccountList"]
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetAppAccount"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-11-01"
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}'}  # type: ignore
    ...
    async def delete(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: NetAppAccount or the result of cls(response)
        :rtype: ~azure.mgmt.netapp.models.NetAppAccount or None
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetAppAccount"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        ...
        return deserialized
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.NetApp/netAppAccounts/{accountName}'}  # type: ignore
