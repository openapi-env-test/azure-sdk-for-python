...
class PoolsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.CapacityPoolList"]
    ...
    def begin_create_or_update(
        ...
        **kwargs  # type: Any
        ...
        :return: An instance of LROPoller that returns CapacityPool
    ...
    def _update_initial(
        ...
        account_name,  # type: str
        pool_name,  # type: str
        body,  # type: "models.CapacityPoolPatch"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.CapacityPool"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.CapacityPool"]
