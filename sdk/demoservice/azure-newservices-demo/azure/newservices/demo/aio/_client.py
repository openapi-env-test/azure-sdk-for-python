...
class DemoNewServiceClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype device_update: azure.newservices.demo.aio.operations.DeviceUpdateOperations
    :ivar device_management: DeviceManagementOperations operations
    :vartype device_management: azure.newservices.demo.aio.operations.DeviceManagementOperations
