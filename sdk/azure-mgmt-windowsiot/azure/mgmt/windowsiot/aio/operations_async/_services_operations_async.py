...
class ServicesOperations:
    ...
    async def create_or_update(
        ...
        resource_group_name: str,
        device_name: str,
        device_service: "models.DeviceServiceProperties",
        ...
        **kwargs
        ...
        :type device_service: ~azure.mgmt.windowsiot.models.DeviceServiceProperties
    ...
    def list_by_resource_group(
     ...
     Service.
        :type resource_group_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of DeviceServiceDescriptionListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.windowsiot.models.DeviceServiceDescriptionListResult]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
