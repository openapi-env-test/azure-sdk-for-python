...
class SAPApplicationServerInstancesOperations:
    ...
    async def get(
        ...
        :param application_instance_name: The name of SAP Application Server instance. Required.
    ...
    async def begin_create(
        ...
        **kwargs: Any
        ...
        :param application_instance_name: The name of SAP Application Server instance. Required.
        :type application_instance_name: str
        :param body: The SAP Application Server instance request body. Is either a model type or a IO
