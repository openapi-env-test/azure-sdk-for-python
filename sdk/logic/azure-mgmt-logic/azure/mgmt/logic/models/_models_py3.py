...
class Workflow(Resource):
    ...
    def __init__(self, *, location: str=None, tags=None, state=None, endpoints_configuration=None, integration_account=None, integration_service_environment=None, definition=None, parameters=None, **kwargs) -> None:
