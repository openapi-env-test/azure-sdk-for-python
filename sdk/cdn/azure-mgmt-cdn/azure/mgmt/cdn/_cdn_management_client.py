...
from .operations import ProfilesTestOperations
...
class CdnManagementClient(CdnManagementClientOperationsMixin, SDKClient):
    ...
    :ivar profiles_test: ProfilesTest operations
    :vartype profiles_test: azure.mgmt.cdn.operations.ProfilesTestOperations
    ...
    def __init__(
        ...
        self.profiles_test = ProfilesTestOperations(
