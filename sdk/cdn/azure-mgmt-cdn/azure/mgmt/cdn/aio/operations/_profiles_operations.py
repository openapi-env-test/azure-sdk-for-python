...
class ProfilesOperations:
    ...
    def list_by_resource_group_abcdefgsa(
        self,
        ...
        **kwargs: Any
        ...
        def prepare_request(next_link=None):
            ...
            if not next_link:
                # Construct URL
                url = self.list_by_resource_group_abcdefgsa.metadata['url']  # type: ignore
                path_format_arguments = {
    ...
    list_by_resource_group_abcdefgsa.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles'}  # type: ignore
