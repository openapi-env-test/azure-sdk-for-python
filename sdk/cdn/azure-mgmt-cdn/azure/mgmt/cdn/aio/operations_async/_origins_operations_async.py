...
class OriginsOperations:
    ...
    def list_by_endpoint(
        ...
        **kwargs
        ...
        :return: An iterator like instance of OriginListResult or the result of cls(response)
    ...
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/profiles/{profileName}/endpoints/{endpointName}/origins/{originName}'}  # type: ignore
