...
class PoliciesOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of CdnWebApplicationFirewallPolicyList or the result of cls(response)
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/CdnWebApplicationFirewallPolicies/{policyName}'}  # type: ignore
    ...
    async def update(
        ...
        **kwargs
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Cdn/CdnWebApplicationFirewallPolicies/{policyName}'}  # type: ignore
