...
class DataBoxHeavyJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address, destination_account_details, expected_data_size_in_tera_bytes: int=None, preferences=None, device_password: str=None, **kwargs) -> None:
...
class DiskScheduleAvailabilityRequest(ScheduleAvailabilityRequest):
    ...
    def __init__(self, *, storage_location: str, expected_data_size_in_tera_bytes: int, **kwargs) -> None:
...
class JobResource(Resource):
    ...
    def __init__(self, *, location: str, sku, tags=None, details=None, delivery_type="NonScheduled", delivery_info=None, **kwargs) -> None:
