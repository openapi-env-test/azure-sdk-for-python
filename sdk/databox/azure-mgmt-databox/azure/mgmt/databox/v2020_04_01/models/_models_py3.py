...
class JobDetails(Model):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, expected_data_size_in_tera_bytes: int=None, **kwargs) -> None:
...
class DataBoxDiskJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, expected_data_size_in_tera_bytes: int=None, preferred_disks=None, passkey: str=None, **kwargs) -> None:
...
class DataBoxHeavyJobDetails(JobDetails):
    ...
    def __init__(self, *, contact_details, shipping_address=None, data_import_details=None, data_export_details=None, preferences=None, expected_data_size_in_tera_bytes: int=None, device_password: str=None, **kwargs) -> None:
...
class DataExportDetails(Model):
    ...
    :param log_collection_level: Level of the logs to be collected. Possible
     values include: 'Error', 'Verbose'. Default value: "Error" .
    ...
    def __init__(self, *, transfer_configuration, account_details, log_collection_level="Error", **kwargs) -> None:
...
class JobResource(Resource):
    ...
    def __init__(self, *, location: str, sku, transfer_type, tags=None, identity=None, details=None, delivery_type="NonScheduled", delivery_info=None, **kwargs) -> None:
...
class KeyEncryptionKey(Model):
    ...
    :param kek_type: Required. Type of encryption key used for key encryption.
     Possible values include: 'MicrosoftManaged', 'CustomerManaged'. Default
    ...
    def __init__(self, *, kek_type="MicrosoftManaged", kek_url: str=None, kek_vault_resource_id: str=None, **kwargs) -> None:
...
class NotificationPreference(Model):
    ...
    def __init__(self, *, stage_name, send_notification: bool=True, **kwargs) -> None:
...
class TransferAllDetails(Model):
    ...
    :param data_account_type: Required. Type of the account of data. Possible
     values include: 'StorageAccount', 'ManagedDisk'. Default value:
     "StorageAccount" .
    ...
    def __init__(self, *, data_account_type="StorageAccount", transfer_all_blobs: bool=None, transfer_all_files: bool=None, **kwargs) -> None:
...
class TransferFilterDetails(Model):
    ...
    def __init__(self, *, data_account_type="StorageAccount", blob_filter_details=None, azure_file_filter_details=None, filter_file_details=None, **kwargs) -> None:
