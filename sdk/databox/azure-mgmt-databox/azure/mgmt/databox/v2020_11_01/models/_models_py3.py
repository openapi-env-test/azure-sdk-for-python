...
class EncryptionPreferences(Model):
    ...
    def __init__(self, *, double_encryption="Disabled", **kwargs) -> None:
...
class KeyEncryptionKey(Model):
    ...
    def __init__(self, *, kek_type="MicrosoftManaged", identity_properties=None, kek_url: str=None, kek_vault_resource_id: str=None, **kwargs) -> None:
...
class ResourceIdentity(Model):
    ...
    :param type: Identity type. Default value: "None" .
    :type type: str
