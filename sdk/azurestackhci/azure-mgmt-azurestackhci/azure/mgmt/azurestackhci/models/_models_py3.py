...
class Cluster(TrackedResource):
    ...
    def __init__(self, *, location: str, aad_client_id: str, aad_tenant_id: str, tags=None, created_by: str=None, created_by_type=None, created_at=None, last_modified_by: str=None, last_modified_by_type=None, last_modified_at=None, reported_properties=None, **kwargs) -> None:
