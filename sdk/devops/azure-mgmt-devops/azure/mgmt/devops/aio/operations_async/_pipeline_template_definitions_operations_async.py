...
class PipelineTemplateDefinitionsOperations:
    ...
    def list(
        ...
        **kwargs
        ...
        :return: An iterator like instance of PipelineTemplateDefinitionListResult or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.devops.models.PipelineTemplateDefinitionListResult]
