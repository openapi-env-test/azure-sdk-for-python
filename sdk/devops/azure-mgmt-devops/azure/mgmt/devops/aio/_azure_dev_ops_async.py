...
from .operations_async import PipelineTemplateDefinitionsOperations
...
class AzureDevOps(object):
    ...
    :vartype operations: azure.mgmt.devops.aio.operations_async.Operations
    :ivar pipeline_template_definitions: PipelineTemplateDefinitionsOperations operations
    :vartype pipeline_template_definitions: azure.mgmt.devops.aio.operations_async.PipelineTemplateDefinitionsOperations
    :ivar pipelines: PipelinesOperations operations
    :vartype pipelines: azure.mgmt.devops.aio.operations_async.PipelinesOperations
