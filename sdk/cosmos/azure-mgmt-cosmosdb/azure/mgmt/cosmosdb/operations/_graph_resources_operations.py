...
def build_list_graphs_request(
    subscription_id: str, resource_group_name: str, account_name: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_graph_request(
    subscription_id: str, resource_group_name: str, account_name: str, graph_name: str, **kwargs: Any
) -> HttpRequest:
    api_version = kwargs.pop("api_version", "2022-02-15-preview")  # type: str
