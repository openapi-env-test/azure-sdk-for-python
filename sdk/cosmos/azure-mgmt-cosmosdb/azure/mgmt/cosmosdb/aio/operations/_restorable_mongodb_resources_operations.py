...
class RestorableMongodbResourcesOperations:
    ...
    def list(
        ...
        **kwargs: Any
    ) -> AsyncIterable["_models.DatabaseRestoreResource"]:
        ...
        :return: An iterator like instance of either DatabaseRestoreResource or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.cosmosdb.models.DatabaseRestoreResource]
