...
class ConfigurationsOperations:
    ...
    def list_by_subscription(self, **kwargs) -> AsyncIterable["_models.ConfigurationListResult"]:
    ...
    def list_by_resource_group(self, resource_group: str, **kwargs) -> AsyncIterable["_models.ConfigurationListResult"]:
        """Retrieve Azure Advisor configurations.
