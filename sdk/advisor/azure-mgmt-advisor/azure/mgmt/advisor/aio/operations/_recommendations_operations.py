...
from ...operations._recommendations_operations import (
    ...
    build_get_generate_recommendations_status_request,
    build_get_request,
    build_list_request,
)
...
class RecommendationsOperations:
    ...
    @distributed_trace_async
    async def get_generate_recommendations_status(  # pylint: disable=inconsistent-return-statements
        ...
        request = build_get_generate_recommendations_status_request(
            operation_id=operation_id,
            subscription_id=self._config.subscription_id,
            api_version=api_version,
            template_url=self.get_generate_recommendations_status.metadata["url"],
            headers=_headers,
            params=_params,
        )
        request = _convert_request(request)
    ...
    get_generate_recommendations_status.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Advisor/generateRecommendations/{operationId}"}  # type: ignore
    ...
    def list(
        ...
        :param filter: The filter to apply to the recommendations. Default value is None.
        :type filter: str
