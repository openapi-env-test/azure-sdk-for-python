...
class EdgeOrderManagementClientOperationsMixin(MixinABC):  # pylint: disable=too-many-public-methods
    ...
    def begin_create_address(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = self._create_address_initial(  # type: ignore
                address_name=address_name,
                resource_group_name=resource_group_name,
    ...
    def begin_update_address(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_address_initial(  # type: ignore
                address_name=address_name,
                resource_group_name=resource_group_name,
    ...
    def begin_create_order_item(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._create_order_item_initial(  # type: ignore
                order_item_name=order_item_name,
                resource_group_name=resource_group_name,
    ...
    def begin_update_order_item(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = self._update_order_item_initial(  # type: ignore
                order_item_name=order_item_name,
                resource_group_name=resource_group_name,
