...
class EdgeOrderManagementClientOperationsMixin(MixinABC):  # pylint: disable=too-many-public-methods
    @distributed_trace
    ...
    async def begin_create_address(
        ...
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._create_address_initial(  # type: ignore
                address_name=address_name,
                resource_group_name=resource_group_name,
    ...
    async def begin_update_address(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_address_initial(  # type: ignore
                address_name=address_name,
                resource_group_name=resource_group_name,
    ...
    async def begin_create_order_item(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._create_order_item_initial(  # type: ignore
                order_item_name=order_item_name,
                resource_group_name=resource_group_name,
    ...
    async def begin_update_order_item(
        ...
        **kwargs: Any
        ...
        cont_token = kwargs.pop("continuation_token", None)  # type: Optional[str]
        if cont_token is None:
            raw_result = await self._update_order_item_initial(  # type: ignore
                order_item_name=order_item_name,
                resource_group_name=resource_group_name,
    ...
    async def begin_return_order_item(
        ...
        **kwargs: Any
        ...
        :param resource_group_name: The name of the resource group. The name is case insensitive.
         Required.
        :type resource_group_name: str
        :param return_order_item_details: Return order item CurrentStatus. Is either a model type or a
         IO type. Required.
        :type return_order_item_details:
