...
class CreateOption(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class EnableState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class InvitationState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class LabState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class OsState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class RegistrationState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class ShutdownOnIdleMode(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
...
class VirtualMachineState(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
    """The state of a virtual machine.
    """
...
class VirtualMachineType(with_metaclass(_CaseInsensitiveEnumMeta, str, Enum)):
