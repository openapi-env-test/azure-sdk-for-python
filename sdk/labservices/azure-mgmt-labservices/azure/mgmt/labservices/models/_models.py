...
class AutoShutdownProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.shutdown_on_disconnect = kwargs.get('shutdown_on_disconnect', None)
        self.shutdown_when_not_connected = kwargs.get('shutdown_when_not_connected', None)
        self.shutdown_on_idle = kwargs.get('shutdown_on_idle', None)
        self.disconnect_delay = kwargs.get('disconnect_delay', None)
        self.no_connect_delay = kwargs.get('no_connect_delay', None)
        self.idle_delay = kwargs.get('idle_delay', None)
...
class ConnectionProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.web_ssh_access = kwargs.get('web_ssh_access', None)
        self.web_rdp_access = kwargs.get('web_rdp_access', None)
        self.client_ssh_access = kwargs.get('client_ssh_access', None)
        self.client_rdp_access = kwargs.get('client_rdp_access', None)
...
class Lab(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.system_data = None
        self.auto_shutdown_profile = kwargs.get('auto_shutdown_profile', None)
        self.connection_profile = kwargs.get('connection_profile', None)
        ...
        self.roster_profile = kwargs.get('roster_profile', None)
        self.lab_plan_id = kwargs.get('lab_plan_id', None)
...
class LabNetworkProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.public_ip_id = kwargs.get('public_ip_id', None)
...
class LabPlan(TrackedResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.system_data = None
        self.default_connection_profile = kwargs.get('default_connection_profile', None)
        self.default_auto_shutdown_profile = kwargs.get('default_auto_shutdown_profile', None)
        self.default_network_profile = kwargs.get('default_network_profile', None)
        self.allowed_regions = kwargs.get('allowed_regions', None)
        self.shared_gallery_id = kwargs.get('shared_gallery_id', None)
        self.support_info = kwargs.get('support_info', None)
        self.linked_lms_instance = kwargs.get('linked_lms_instance', None)
        self.provisioning_state = None
...
class LabPlanProperties(LabPlanUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LabPlanProperties, self).__init__(**kwargs)
        self.provisioning_state = None
...
class LabPlanUpdate(TrackedResourceUpdate):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LabPlanUpdate, self).__init__(**kwargs)
        self.default_connection_profile = kwargs.get('default_connection_profile', None)
        self.default_auto_shutdown_profile = kwargs.get('default_auto_shutdown_profile', None)
        self.default_network_profile = kwargs.get('default_network_profile', None)
        self.allowed_regions = kwargs.get('allowed_regions', None)
...
class LabProperties(LabUpdateProperties):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LabProperties, self).__init__(**kwargs)
        self.provisioning_state = None
        self.network_profile = kwargs.get('network_profile', None)
        self.state = None
...
class LabUpdate(TrackedResourceUpdate):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(LabUpdate, self).__init__(**kwargs)
        self.auto_shutdown_profile = kwargs.get('auto_shutdown_profile', None)
        self.connection_profile = kwargs.get('connection_profile', None)
        self.virtual_machine_profile = kwargs.get('virtual_machine_profile', None)
        self.security_profile = kwargs.get('security_profile', None)
...
class RosterProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.active_directory_group_id = kwargs.get('active_directory_group_id', None)
        self.lti_context_id = kwargs.get('lti_context_id', None)
        self.lms_instance = kwargs.get('lms_instance', None)
        self.lti_client_id = kwargs.get('lti_client_id', None)
        self.lti_roster_endpoint = kwargs.get('lti_roster_endpoint', None)
...
class SaveImageBody(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.lab_virtual_machine_id = kwargs.get('lab_virtual_machine_id', None)
...
class SecurityProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.open_access = kwargs.get('open_access', None)
...
class User(ProxyResource):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.system_data = None
        self.additional_usage_quota = kwargs.get('additional_usage_quota', None)
        self.provisioning_state = None
        self.display_name = None
...
class VirtualMachineAdditionalCapabilities(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.install_gpu_drivers = kwargs.get('install_gpu_drivers', None)
...
class VirtualMachineProfile(msrest.serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.usage_quota = kwargs['usage_quota']
        self.use_shared_password = kwargs.get('use_shared_password', None)
        self.admin_user = kwargs['admin_user']
        self.non_admin_user = kwargs.get('non_admin_user', None)
