...
class OperationResultsOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Optional["_models.OperationResult"]
        ...
        path_format_arguments = {
            ...
            'operationResultId': self._serialize.url("operation_result_id", operation_result_id, 'str', max_length=100, min_length=1, pattern=r'^[-\w\\._\\(\\)]+$'),
        }
