...
class ImagesOperations(object):
    ...
    def list_by_lab_plan(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PagedImages"]
        """Gets all images.
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'labPlanName': self._serialize.url("lab_plan_name", lab_plan_name, 'str', max_length=100, min_length=1),
            'imageName': self._serialize.url("image_name", image_name, 'str', max_length=100, min_length=1, pattern=r'^[-\w\\._\\(\\)]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def create_or_update(
        ...
        **kwargs  # type: Any
        ...
        body_content = self._serialize.body(body, 'Image')
    ...
    def update(
        ...
        **kwargs  # type: Any
        ...
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(body, 'ImageUpdate')
        body_content_kwargs['content'] = body_content
