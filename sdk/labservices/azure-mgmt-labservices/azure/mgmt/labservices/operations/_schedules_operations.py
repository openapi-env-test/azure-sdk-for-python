...
class SchedulesOperations(object):
    ...
    def list_by_lab(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["_models.PagedSchedules"]
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        path_format_arguments = {
            ...
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1),
            'labName': self._serialize.url("lab_name", lab_name, 'str', max_length=100, min_length=1),
            'scheduleName': self._serialize.url("schedule_name", schedule_name, 'str', max_length=100, min_length=1, pattern=r'^[-\w\\._\\(\\)]+$'),
        }
        url = self._client.format_url(url, **path_format_arguments)
    ...
    def update(
        ...
        lab_name,  # type: str
        schedule_name,  # type: str
        body,  # type: "_models.ScheduleUpdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "_models.Schedule"
