...
class QueriesOperations:
    ...
    @distributed_trace
    def list(self, resource_group_name: str, workspace_name: str, **kwargs: Any) -> Iterable["_models.Query"]:
        """Gets all queries.
        ...
        :rtype: ~azure.core.paging.ItemPaged[~azure.mgmt.securityinsight.models.Query]
    ...
    @distributed_trace
    def get(self, resource_group_name: str, workspace_name: str, query_id: str, **kwargs: Any) -> _models.Query:
        """Gets a query.
