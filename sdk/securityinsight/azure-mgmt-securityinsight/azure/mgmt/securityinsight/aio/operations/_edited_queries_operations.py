...
from ...operations._edited_queries_operations import (
...
class EditedQueriesOperations:
    ...
    def list(
    ...
    ) -> AsyncIterable["_models.EditedQuery"]:
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.securityinsight.models.EditedQuery]
