...
class BatchAccountOperations:
    ...
    async def _create_abc_initial(
        ...
        **kwargs: Any
        ...
        # Construct URL
        url = self._create_abc_initial.metadata['url']  # type: ignore
        ...
        return deserialized
    _create_abc_initial.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}'}  # type: ignore

    async def begin_create_abc(
        self,
        resource_group_name: str,
        account_name: str,
        parameters: "_models.BatchAccountCreateParameters",
        **kwargs: Any
        ...
        if cont_token is None:
            raw_result = await self._create_abc_initial(
    ...
    begin_create_abc.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Batch/batchAccounts/{accountName}'}  # type: ignore
