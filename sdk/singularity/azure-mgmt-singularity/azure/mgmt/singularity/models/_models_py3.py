...
class ErrorDefinition(_serialization.Model):
    ...
    :vartype details: list[~azure.mgmt.singularity.models.ErrorDefinition]
    """
...
class ErrorResponse(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.singularity.models.ErrorDefinition
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDefinition"] = None, **kwargs):
        ...
        :paramtype error: ~azure.mgmt.singularity.models.ErrorDefinition
        """
        super().__init__(**kwargs)
        self.error = error
