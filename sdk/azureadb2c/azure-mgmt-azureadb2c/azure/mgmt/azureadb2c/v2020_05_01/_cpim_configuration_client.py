...
class CPIMConfigurationClient(SDKClient):
    ...
    :vartype b2_ctenants: azure.mgmt.azureadb2c.v2019_01_01.operations.B2CTenantsOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.azureadb2c.v2019_01_01.operations.Operations
    ...
    def __init__(
        ...
        self.config = CPIMConfigurationClientConfiguration(credentials, base_url)
