...
class MachineProperties(Model):
    ...
    def __init__(self, *, location_data=None, os_profile=None, vm_id: str=None, client_public_key: str=None, extensions=None, private_link_scope_resource_id: str=None, **kwargs) -> None:
...
class MachineUpdateProperties(Model):
    ...
    def __init__(self, *, location_data=None, private_link_scope_resource_id: str=None, **kwargs) -> None:
