...
class BackupInstance(Model):
    ...
    :param friendly_name: Required. Gets or sets the Backup Instance friendly
     name.
    :type friendly_name: str
    ...
    def __init__(self, *, friendly_name: str, data_source_info, policy_info, object_type: str, data_source_set_info=None, **kwargs) -> None:
...
class BackupInstanceResource(DppResource):
    ...
    def __init__(self, *, friendly_name: str, data_source_info, policy_info, object_type: str, system_data=None, data_source_set_info=None, **kwargs) -> None:
