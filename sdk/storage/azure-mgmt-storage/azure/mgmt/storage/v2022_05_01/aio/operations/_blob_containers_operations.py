...
class BlobContainersOperations:
    ...
    async def lease(
        ...
        account_name: str,
        container_name: str,
        parameters: Optional[_models.LeaseContainerRequestAutoGenerated] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
        ...
        :type parameters: ~azure.mgmt.storage.v2022_05_01.models.LeaseContainerRequestAutoGenerated
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    async def lease(
        ...
        account_name: str,
        container_name: str,
        parameters: Optional[Union[_models.LeaseContainerRequestAutoGenerated, IO]] = None,
        **kwargs: Any
    ) -> _models.LeaseContainerResponse:
        """The Lease Container operation establishes and manages a lock on a container for delete
        operations. The lock duration can be 15 to 60 seconds, or can be infinite.
        ...
        :param parameters: Lease Container request body. Is either a model type or a IO type. Default
         value is None.
        :type parameters: ~azure.mgmt.storage.v2022_05_01.models.LeaseContainerRequestAutoGenerated or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        if isinstance(parameters, (IO, bytes)):
            ...
            if parameters is not None:
                _json = self._serialize.body(parameters, "LeaseContainerRequestAutoGenerated")
            else:
                _json = None
