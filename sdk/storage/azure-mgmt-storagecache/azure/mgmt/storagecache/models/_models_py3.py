...
class Cache(_serialization.Model):  # pylint: disable=too-many-instance-attributes
    ...
    :ivar scaling_factor: Multiplier that sets the current storage and throughput capacity of the
     ...
     that's 33% larger than its base size. Known values are: 1, 1.33, 2, and 4.
    ...
    def __init__(
        ...
        *,
        ...
        scaling_factor: Union[float, "_models.ScalingFactor"] = 1,
        ...
        **kwargs
        ...
        :keyword scaling_factor: Multiplier that sets the current storage and throughput capacity of
         ...
         cache that's 33% larger than its base size. Known values are: 1, 1.33, 2, and 4.
