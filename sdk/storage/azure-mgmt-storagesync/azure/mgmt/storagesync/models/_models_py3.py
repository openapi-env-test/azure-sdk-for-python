...
class RegisteredServer(ProxyResource):
    ...
    :param telemetry_endpoint_uri: Telemetry Endpoint Uri
    :type telemetry_endpoint_uri: str
    ...
    _attribute_map = {
        ...
        'telemetry_endpoint_uri': {'key': 'properties.telemetryEndpointUri', 'type': 'str'},
        'monitoring_configuration': {'key': 'properties.monitoringConfiguration', 'type': 'str'},
    }

    def __init__(self, *, server_certificate: str=None, agent_version: str=None, server_os_version: str=None, server_management_error_code: int=None, last_heart_beat: str=None, provisioning_state: str=None, server_role: str=None, cluster_id: str=None, cluster_name: str=None, server_id: str=None, storage_sync_service_uid: str=None, last_workflow_id: str=None, last_operation_name: str=None, discovery_endpoint_uri: str=None, resource_location: str=None, service_location: str=None, friendly_name: str=None, management_endpoint_uri: str=None, telemetry_endpoint_uri: str=None, monitoring_configuration: str=None, **kwargs) -> None:
        ...
        self.telemetry_endpoint_uri = telemetry_endpoint_uri
...
class StorageSyncService(TrackedResource):
    ...
    :param incoming_traffic_policy: Incoming Traffic Policy. Possible values
     include: 'AllowInternetTraffic', 'AllowVirtualNetworks'
