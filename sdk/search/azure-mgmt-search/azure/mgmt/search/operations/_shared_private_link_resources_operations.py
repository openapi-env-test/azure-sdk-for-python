...
class SharedPrivateLinkResourcesOperations(object):
    ...
    def create_or_update(
        ...
        properties=None,  # type: Optional["models.SharedPrivateLinkResourceProperties"]
        ...
        **kwargs  # type: Any
        ...
        _shared_private_link_resource = models.SharedPrivateLinkResource(properties=properties)
        ...
        body_content = self._serialize.body(_shared_private_link_resource, 'SharedPrivateLinkResource')
        ...
        return deserialized
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}'}  # type: ignore
    ...
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}/sharedPrivateLinkResources/{sharedPrivateLinkResourceName}'}  # type: ignore
    ...
    def list_by_service(
     ...
     specified resource group.
        ...
        :type search_management_request_options: ~azure.mgmt.search.models.SearchManagementRequestOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of SharedPrivateLinkResourceListResult or the result of cls(response)
