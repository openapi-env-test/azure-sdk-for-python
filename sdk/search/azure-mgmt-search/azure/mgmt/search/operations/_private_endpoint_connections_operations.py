...
class PrivateEndpointConnectionsOperations(object):
    ...
    def update(
        ...
        properties=None,  # type: Optional["models.PrivateEndpointConnectionProperties"]
        ...
        **kwargs  # type: Any
        ...
        _private_endpoint_connection = models.PrivateEndpointConnection(properties=properties)
