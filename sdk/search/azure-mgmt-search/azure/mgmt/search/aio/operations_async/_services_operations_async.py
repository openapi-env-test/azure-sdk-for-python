...
class ServicesOperations:
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Search/searchServices/{searchServiceName}'}  # type: ignore
    ...
    def list_by_resource_group(
     ...
     can obtain this value from the Azure Resource Manager API or the portal.
        ...
        :type search_management_request_options: ~azure.mgmt.search.models.SearchManagementRequestOptions
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of SearchServiceListResult or the result of cls(response)
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        """Checks whether or not the given Search service name is available for use. Search service names must be globally unique since they are part of the service URI (https://:code:`<name>`.search.windows.net).
