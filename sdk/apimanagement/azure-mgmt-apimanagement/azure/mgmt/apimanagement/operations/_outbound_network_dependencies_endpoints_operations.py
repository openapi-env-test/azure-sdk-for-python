...
class OutboundNetworkDependenciesEndpointsOperations(object):
    ...
    def list_by_service(
        ...
        :return: OutboundEnvironmentEndpointList or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.apimanagement.models.OutboundEnvironmentEndpointList or
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('OutboundEnvironmentEndpointList', response)
