...
class ShareSubscriptionsOperations(object):
    ...
    def create(
            self, resource_group_name, account_name, share_subscription_name, share_subscription, custom_headers=None, raw=False, **operation_config):
        ...
        :type share_subscription:
         ~azure.mgmt.datashare.models.ShareSubscription
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
