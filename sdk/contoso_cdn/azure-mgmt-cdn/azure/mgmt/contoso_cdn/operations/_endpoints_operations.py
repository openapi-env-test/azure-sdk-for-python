...
class EndpointsOperations(object):
    ...
    def list_by_profile(
        ...
        :rtype:
         ~azure.mgmt.contoso_cdn.models.EndpointPaged[~azure.mgmt.contoso_cdn.models.Endpoint]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.contoso_cdn.models.ErrorResponseException>`
        """
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.contoso_cdn.models.Endpoint or
    ...
    def create(
        ...
        :type endpoint: ~azure.mgmt.contoso_cdn.models.Endpoint
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.contoso_cdn.models.Endpoint]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.contoso_cdn.models.Endpoint]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.contoso_cdn.models.ErrorResponseException>`
        """
    ...
    def update(
        ...
        :type endpoint_update_properties:
         ~azure.mgmt.contoso_cdn.models.EndpointUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def list_resource_usage(
        ...
        :rtype:
         ~azure.mgmt.contoso_cdn.models.ResourceUsagePaged[~azure.mgmt.contoso_cdn.models.ResourceUsage]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.contoso_cdn.models.ErrorResponseException>`
        """
        def prepare_request(next_link=None):
