...
class AFDEndpointsOperations(object):
    ...
    def list_by_profile(
        ...
        :rtype:
         ~azure.mgmt.contoso_cdn.models.AFDEndpointPaged[~azure.mgmt.contoso_cdn.models.AFDEndpoint]
        :raises:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.contoso_cdn.models.AFDEndpoint or
    ...
    def create(
        ...
        :type endpoint: ~azure.mgmt.contoso_cdn.models.AFDEndpoint
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.contoso_cdn.models.AFDEndpoint]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.contoso_cdn.models.AFDEndpoint]]
        :raises:
         :class:`AfdErrorResponseException<azure.mgmt.contoso_cdn.models.AfdErrorResponseException>`
        """
    ...
    def update(
        ...
        :type endpoint_update_properties:
         ~azure.mgmt.contoso_cdn.models.AFDEndpointUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
    ...
    def list_resource_usage(
        ...
        :rtype:
         ~azure.mgmt.contoso_cdn.models.UsagePaged[~azure.mgmt.contoso_cdn.models.Usage]
        :raises:
         :class:`AfdErrorResponseException<azure.mgmt.contoso_cdn.models.AfdErrorResponseException>`
        """
        def prepare_request(next_link=None):
    ...
    def validate_custom_domain(
        ...
        :rtype: ~azure.mgmt.contoso_cdn.models.ValidateCustomDomainOutput or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`AfdErrorResponseException<azure.mgmt.contoso_cdn.models.AfdErrorResponseException>`
        """
