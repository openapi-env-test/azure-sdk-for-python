...
class CustomDomainsOperations(object):
    ...
    def list_by_endpoint(
        ...
        :rtype:
         ~azure.mgmt.contoso_cdn.models.CustomDomainPaged[~azure.mgmt.contoso_cdn.models.CustomDomain]
        :raises:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.contoso_cdn.models.CustomDomain or
    ...
    def create(
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.contoso_cdn.models.CustomDomain]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.contoso_cdn.models.CustomDomain]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.contoso_cdn.models.ErrorResponseException>`
        """
    ...
    def enable_custom_https(
        ...
        :type custom_domain_https_parameters:
         ~azure.mgmt.contoso_cdn.models.CustomDomainHttpsParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
