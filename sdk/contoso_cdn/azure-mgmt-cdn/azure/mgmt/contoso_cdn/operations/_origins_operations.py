...
class OriginsOperations(object):
    ...
    def list_by_endpoint(
        ...
        :rtype:
         ~azure.mgmt.contoso_cdn.models.OriginPaged[~azure.mgmt.contoso_cdn.models.Origin]
        :raises:
    ...
    def get(
        ...
        :rtype: ~azure.mgmt.contoso_cdn.models.Origin or
    ...
    def create(
        ...
        :type origin: ~azure.mgmt.contoso_cdn.models.Origin
        :param dict custom_headers: headers that will be added to the request
        ...
        :rtype:
         ~msrestazure.azure_operation.AzureOperationPoller[~azure.mgmt.contoso_cdn.models.Origin]
         or
         ~msrestazure.azure_operation.AzureOperationPoller[~msrest.pipeline.ClientRawResponse[~azure.mgmt.contoso_cdn.models.Origin]]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.contoso_cdn.models.ErrorResponseException>`
        """
    ...
    def update(
        ...
        :type origin_update_properties:
         ~azure.mgmt.contoso_cdn.models.OriginUpdateParameters
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: The poller return type is ClientRawResponse, the
         direct response alongside the deserialized response
        :param polling: True for ARMPolling, False for no polling, or a
