...
class CdnManagementClient(CdnManagementClientOperationsMixin, SDKClient):
    ...
    :vartype profiles: azure.mgmt.contoso_cdn.operations.ProfilesOperations
    :ivar endpoints: Endpoints operations
    :vartype endpoints: azure.mgmt.contoso_cdn.operations.EndpointsOperations
    :ivar origins: Origins operations
    :vartype origins: azure.mgmt.contoso_cdn.operations.OriginsOperations
    :ivar origin_groups: OriginGroups operations
    :vartype origin_groups: azure.mgmt.contoso_cdn.operations.OriginGroupsOperations
    :ivar custom_domains: CustomDomains operations
    :vartype custom_domains: azure.mgmt.contoso_cdn.operations.CustomDomainsOperations
    :ivar resource_usage: ResourceUsage operations
    :vartype resource_usage: azure.mgmt.contoso_cdn.operations.ResourceUsageOperations
    :ivar operations: Operations operations
    :vartype operations: azure.mgmt.contoso_cdn.operations.Operations
    :ivar edge_nodes: EdgeNodes operations
    :vartype edge_nodes: azure.mgmt.contoso_cdn.operations.EdgeNodesOperations
    :ivar afd_profiles: AFDProfiles operations
    :vartype afd_profiles: azure.mgmt.contoso_cdn.operations.AFDProfilesOperations
    :ivar afd_custom_domains: AFDCustomDomains operations
    :vartype afd_custom_domains: azure.mgmt.contoso_cdn.operations.AFDCustomDomainsOperations
    :ivar afd_endpoints: AFDEndpoints operations
    :vartype afd_endpoints: azure.mgmt.contoso_cdn.operations.AFDEndpointsOperations
    :ivar afd_origin_groups: AFDOriginGroups operations
    :vartype afd_origin_groups: azure.mgmt.contoso_cdn.operations.AFDOriginGroupsOperations
    :ivar afd_origins: AFDOrigins operations
    :vartype afd_origins: azure.mgmt.contoso_cdn.operations.AFDOriginsOperations
    :ivar routes: Routes operations
    :vartype routes: azure.mgmt.contoso_cdn.operations.RoutesOperations
    :ivar rule_sets: RuleSets operations
    :vartype rule_sets: azure.mgmt.contoso_cdn.operations.RuleSetsOperations
    :ivar rules: Rules operations
    :vartype rules: azure.mgmt.contoso_cdn.operations.RulesOperations
    :ivar security_policies: SecurityPolicies operations
    :vartype security_policies: azure.mgmt.contoso_cdn.operations.SecurityPoliciesOperations
    :ivar secrets: Secrets operations
    :vartype secrets: azure.mgmt.contoso_cdn.operations.SecretsOperations
    :ivar validate: Validate operations
    :vartype validate: azure.mgmt.contoso_cdn.operations.ValidateOperations
    :ivar log_analytics: LogAnalytics operations
    :vartype log_analytics: azure.mgmt.contoso_cdn.operations.LogAnalyticsOperations
    :ivar policies: Policies operations
    :vartype policies: azure.mgmt.contoso_cdn.operations.PoliciesOperations
    :ivar managed_rule_sets: ManagedRuleSets operations
    :vartype managed_rule_sets: azure.mgmt.contoso_cdn.operations.ManagedRuleSetsOperations
