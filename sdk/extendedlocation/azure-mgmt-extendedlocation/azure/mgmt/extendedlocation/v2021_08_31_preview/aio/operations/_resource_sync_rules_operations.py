...
from ...operations._resource_sync_rules_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_by_custom_location_id_request, build_update_request
T = TypeVar('T')
...
class ResourceSyncRulesOperations:
    ...
    async def _update_initial(
        ...
        **kwargs: Any
        ...
        _parameters = _models.PatchableResourceSyncRule(priority=priority, selector=selector, tags=tags, target_resource_group=target_resource_group)
