...
class CustomLocationsOperations:
    ...
    def list_operations(
        self,
        **kwargs: Any
    ) -> AsyncIterable["_models.CustomLocationOperation"]:
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        resource_name: str,
        parameters: Union[_models.CustomLocation, IO],
        **kwargs: Any
    ) -> _models.CustomLocation:
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
    ...
    async def update(
        ...
        **kwargs: Any
        ...
        _parameters = _models.PatchableCustomLocations(authentication=authentication, cluster_extension_ids=cluster_extension_ids, display_name=display_name, host_resource_id=host_resource_id, host_type=host_type, identity=identity, namespace=namespace, provisioning_state=provisioning_state, tags=tags)
