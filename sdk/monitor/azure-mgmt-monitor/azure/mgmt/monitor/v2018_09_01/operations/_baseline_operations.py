...
def build_get_request(
    ...
    **kwargs  # type: Any
    ...
    # type: (...) -> HttpRequest
    metricnames = kwargs.pop('metricnames', None)  # type: Optional[str]
    timespan = kwargs.pop('timespan', None)  # type: Optional[str]
    interval = kwargs.pop('interval', None)  # type: Optional[datetime.timedelta]
    aggregation = kwargs.pop('aggregation', None)  # type: Optional[str]
    sensitivities = kwargs.pop('sensitivities', None)  # type: Optional[str]
    result_type = kwargs.pop('result_type', None)  # type: Optional[Union[str, "_models.ResultType"]]
    metricnamespace = kwargs.pop('metricnamespace', None)  # type: Optional[str]
