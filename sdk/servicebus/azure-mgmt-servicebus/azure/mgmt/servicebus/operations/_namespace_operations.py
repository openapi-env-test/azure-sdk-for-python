...
class NamespaceOperations(object):
    ...
    def get(
        ...
        :param location_name: Name of the Location within the Azure.
        :type location_name: str
        :param operation_result_id: Name of the Namespace.
    ...
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.ServiceBus/locations/{locationName}/namespaceOperations/{operationResultId}'}
