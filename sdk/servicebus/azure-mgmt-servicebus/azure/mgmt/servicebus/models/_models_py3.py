...
class SBClientAffineProperties(Model):
    """SBClientAffineProperties.

    :param client_id: Indicates the Client ID of the application that created
     the client-affine subscription.
    :type client_id: str
    :param is_durable: For client-affine subscriptions, this value indicates
     whether the subscription is durable or not.
    :type is_durable: bool
    :param is_shared: For client-affine subscriptions, this value indicates
    ...
    def __init__(self, *, client_id: str=None, is_durable: bool=None, is_shared: bool=None, **kwargs) -> None:
...
class SBSubscription(Resource):
    ...
    :param forward_dead_lettered_messages_to: Queue/Topic name to forward the
     Dead Letter message
    :type forward_dead_lettered_messages_to: str
    :param is_client_affine: Value that indicates whether the subscription has
     an affinity to the client id.
    :type is_client_affine: bool
    :param client_affine_properties: Properties specific to client affine
     subscriptions.
    :type client_affine_properties:
     ~azure.mgmt.servicebus.models.SBClientAffineProperties
    """
