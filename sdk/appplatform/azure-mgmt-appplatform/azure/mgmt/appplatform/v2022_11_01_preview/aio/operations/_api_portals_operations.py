...
from ...operations._api_portals_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request, build_validate_domain_request
T = TypeVar('T')
