...
from ...operations._apps_operations import build_create_or_update_request, build_delete_request, build_get_request, build_get_resource_upload_url_request, build_list_request, build_set_active_deployments_request, build_update_request, build_validate_domain_request
T = TypeVar('T')
...
class AppsOperations:
    ...
    def list(
        ...
        service_name: str,
        **kwargs: Any
    ) -> AsyncIterable["_models.AppResource"]:
