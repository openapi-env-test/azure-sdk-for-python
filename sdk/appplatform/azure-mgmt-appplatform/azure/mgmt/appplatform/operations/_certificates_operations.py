...
class CertificatesOperations(object):
    ...
    def _create_or_update_initial(
            self, resource_group_name, service_name, certificate_name, properties=None, location=None, custom_headers=None, raw=False, **operation_config):
        certificate_resource = models.CertificateResource(properties=properties, location=location)
    ...
    def create_or_update(
            self, resource_group_name, service_name, certificate_name, properties=None, location=None, custom_headers=None, raw=False, polling=True, **operation_config):
