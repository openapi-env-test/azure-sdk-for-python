...
class AppResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.models.AppResource]
...
class AvailableOperations(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.models.OperationDetail]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BindingResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.models.BindingResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class BindingResourceProperties(msrest.serialization.Model):
    ...
    :param resource_type: The standard Azure resource type of the bound resource.
...
class ClusterResourceProperties(msrest.serialization.Model):
    ...
    :type config_server_properties: ~azure.mgmt.appplatform.models.ConfigServerProperties
...
class ConfigServerGitProperty(msrest.serialization.Model):
    ...
    :type repositories: list[~azure.mgmt.appplatform.models.GitPatternRepository]
...
class DeploymentResourceCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.models.DeploymentResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class DeploymentResourceProperties(msrest.serialization.Model):
    ...
    :type deployment_settings: ~azure.mgmt.appplatform.models.DeploymentSettings
...
class DeploymentSettings(msrest.serialization.Model):
    ...
    :type runtime_version: str or ~azure.mgmt.appplatform.models.RuntimeVersion
    """
...
class OperationProperties(msrest.serialization.Model):
    ...
    :type service_specification: ~azure.mgmt.appplatform.models.ServiceSpecification
    """
...
class ResourceSku(msrest.serialization.Model):
    ...
    :type location_info: list[~azure.mgmt.appplatform.models.ResourceSkuLocationInfo]
    :param restrictions: Gets the restrictions because of which SKU cannot be used. This is
     empty if there are no restrictions.
    :type restrictions: list[~azure.mgmt.appplatform.models.ResourceSkuRestrictions]
    """
...
class ResourceSkuCollection(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.models.ResourceSku]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class ResourceSkuLocationInfo(msrest.serialization.Model):
    ...
    :type zone_details: list[~azure.mgmt.appplatform.models.ResourceSkuZoneDetails]
    """
...
class ResourceSkuRestrictions(msrest.serialization.Model):
    ...
    :type type: str or ~azure.mgmt.appplatform.models.ResourceSkuRestrictionsType
    ...
    :param restriction_info: Gets the information about the restriction where the SKU cannot be
     used.
    :type restriction_info: ~azure.mgmt.appplatform.models.ResourceSkuRestrictionInfo
    ...
    :type reason_code: str or ~azure.mgmt.appplatform.models.ResourceSkuRestrictionsReasonCode
    """
...
class ResourceSkuZoneDetails(msrest.serialization.Model):
    ...
    :type capabilities: list[~azure.mgmt.appplatform.models.ResourceSkuCapabilities]
    """
...
class ServiceResourceList(msrest.serialization.Model):
    ...
    :type value: list[~azure.mgmt.appplatform.models.ServiceResource]
    :param next_link: URL client should use to fetch the next page (per server side paging).
     It's null for now, added for future use.
    :type next_link: str
    """
...
class ServiceSpecification(msrest.serialization.Model):
    ...
    :type log_specifications: list[~azure.mgmt.appplatform.models.LogSpecification]
    :param metric_specifications: Specifications of the Metrics for Azure Monitoring.
    :type metric_specifications: list[~azure.mgmt.appplatform.models.MetricSpecification]
    """
...
class UserSourceInfo(msrest.serialization.Model):
    ...
    :param type: Type of the source uploaded. Possible values include: "Jar", "Source".
