...
from ...operations._configuration_services_operations import build_create_or_update_request, build_delete_request, build_get_request, build_list_request, build_validate_request
T = TypeVar('T')
