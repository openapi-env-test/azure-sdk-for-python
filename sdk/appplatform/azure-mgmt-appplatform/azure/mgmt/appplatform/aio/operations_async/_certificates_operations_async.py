...
class CertificatesOperations:
    ...
    async def create_or_update(
        ...
        service_name: str,
        certificate_name: str,
        properties: Optional["models.CertificateProperties"] = None,
        **kwargs
    ) -> "models.CertificateResource":
    ...
    def list(
        ...
        service_name: str,
        **kwargs
    ) -> AsyncIterable["models.CertificateResourceCollection"]:
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.CertificateResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
