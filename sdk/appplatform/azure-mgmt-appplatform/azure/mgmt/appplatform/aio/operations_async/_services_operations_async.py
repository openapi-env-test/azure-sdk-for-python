...
class ServicesOperations:
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}'}  # type: ignore
    ...
    async def delete(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}'}  # type: ignore
    ...
    async def update(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}'}  # type: ignore
    ...
    async def list_test_keys(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TestKeys"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-05-01-preview"
    ...
    async def regenerate_test_key(
        ...
        resource_group_name: str,
        service_name: str,
        key_type: Union[str, "models.TestKeyType"],
        **kwargs
    ) -> "models.TestKeys":
        ...
        :param service_name: The name of the Service resource.
        :type service_name: str
        :param key_type: Type of the test key.
        ...
        _regenerate_test_key_request = models.RegenerateTestKeyRequestPayload(key_type=key_type)
        api_version = "2019-05-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_regenerate_test_key_request, 'RegenerateTestKeyRequestPayload')
        body_content_kwargs['content'] = body_content
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        _availability_parameters = models.NameAvailabilityParameters(type=type, name=name)
        api_version = "2019-05-01-preview"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_availability_parameters, 'NameAvailabilityParameters')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.ServiceResourceList"]:
        """Handles requests to list all resources in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of ServiceResourceList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.ServiceResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ServiceResourceList"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-05-01-preview"
