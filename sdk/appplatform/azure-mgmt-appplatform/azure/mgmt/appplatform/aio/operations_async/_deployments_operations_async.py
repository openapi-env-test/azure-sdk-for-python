...
class DeploymentsOperations:
    ...
    async def get(
        ...
        **kwargs
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DeploymentResource"]
    ...
    async def _create_or_update_initial(
        ...
        app_name: str,
        deployment_name: str,
        properties: Optional["models.DeploymentResourceProperties"] = None,
        **kwargs
    ) -> "models.DeploymentResource":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DeploymentResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        ...
        _deployment_resource = models.DeploymentResource(properties=properties)
        api_version = "2019-05-01-preview"
        ...
        body_content = self._serialize.body(_deployment_resource, 'DeploymentResource')
    ...
    async def create_or_update(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :type properties: ~azure.mgmt.appplatform.models.DeploymentResourceProperties
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}'}  # type: ignore
    ...
    async def update(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}'}  # type: ignore
    ...
    def list(
        ...
        **kwargs
    ) -> AsyncIterable["models.DeploymentResourceCollection"]:
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of DeploymentResourceCollection or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.DeploymentResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DeploymentResourceCollection"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-05-01-preview"
    ...
    async def start(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    start.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}/start'}  # type: ignore
    ...
    async def stop(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    stop.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}/stop'}  # type: ignore
    ...
    async def restart(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    restart.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppPlatform/Spring/{serviceName}/apps/{appName}/deployments/{deploymentName}/restart'}  # type: ignore
    ...
    async def get_log_file_url(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.LogFileUrlResponse"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2019-05-01-preview"
