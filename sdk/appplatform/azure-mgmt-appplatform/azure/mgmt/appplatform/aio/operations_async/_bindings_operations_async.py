...
class BindingsOperations:
    ...
    async def create_or_update(
        ...
        app_name: str,
        binding_name: str,
        properties: Optional["models.BindingResourceProperties"] = None,
        **kwargs
    ) -> "models.BindingResource":
    ...
    def list(
        ...
        app_name: str,
        **kwargs
    ) -> AsyncIterable["models.BindingResourceCollection"]:
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.BindingResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
