...
class CustomDomainsOperations:
    ...
    async def create_or_update(
        ...
        app_name: str,
        domain_name: str,
        properties: Optional["models.CustomDomainProperties"] = None,
        **kwargs
    ) -> "models.CustomDomainResource":
    ...
    def list(
        ...
        app_name: str,
        **kwargs
    ) -> AsyncIterable["models.CustomDomainResourceCollection"]:
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appplatform.models.CustomDomainResourceCollection]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    async def validate(
        ...
        name: str,
        **kwargs
    ) -> "models.CustomDomainValidateResult":
