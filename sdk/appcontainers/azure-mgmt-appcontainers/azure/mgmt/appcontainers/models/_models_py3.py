...
class ContainerAppPatch(_serialization.Model):
    """Container App Patch.
...
class CustomHostnameAnalysisResult(ProxyResource):  # pylint: disable=too-many-instance-attributes
...
class ManagedEnvironmentPatch(_serialization.Model):
    """An environment for hosting container apps.
