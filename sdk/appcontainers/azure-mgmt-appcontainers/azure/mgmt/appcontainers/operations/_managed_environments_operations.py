...
class ManagedEnvironmentsOperations:
    ...
    def update(
        ...
        **kwargs: Any
        ...
        :type name: str
        :param environment_envelope: Configuration details of the Environment. Required.
        :type environment_envelope: ~azure.mgmt.appcontainers.models.ManagedEnvironmentPatch
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def update(
        ...
        resource_group_name: str,
        name: str,
        environment_envelope: Union[_models.ManagedEnvironmentPatch, IO],
        **kwargs: Any
    ) -> _models.ManagedEnvironment:
        """Update Managed Environment's properties.
        ...
        :param environment_envelope: Configuration details of the Environment. Is either a model type
         or a IO type. Required.
        :type environment_envelope: ~azure.mgmt.appcontainers.models.ManagedEnvironmentPatch or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
