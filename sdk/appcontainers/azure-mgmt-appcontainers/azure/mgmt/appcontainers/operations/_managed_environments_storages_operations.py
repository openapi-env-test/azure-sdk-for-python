...
def build_list_request(resource_group_name: str, env_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
...
def build_get_request(
    resource_group_name: str, env_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class ManagedEnvironmentsStoragesOperations:
    ...
    def list(
        ...
        :param env_name: Name of the Environment. Required.
        :type env_name: str
    ...
    def get(
        ...
        :param env_name: Name of the Environment. Required.
        :type env_name: str
        :param name: Name of the storage. Required.
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
