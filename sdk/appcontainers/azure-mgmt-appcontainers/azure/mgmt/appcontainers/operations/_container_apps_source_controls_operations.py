...
class ContainerAppsSourceControlsOperations:
    ...
    @distributed_trace
    def get(self, resource_group_name: str, container_app_name: str, name: str, **kwargs: Any) -> _models.SourceControl:
        ...
        :param container_app_name: Name of the Container App. Required.
        :type container_app_name: str
        :param name: Name of the Container App SourceControl. Required.
        :type name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
