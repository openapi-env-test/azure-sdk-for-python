...
def build_list_request(
    resource_group_name: str, managed_environment_name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
...
def build_get_request(
    resource_group_name: str, managed_environment_name: str, name: str, subscription_id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class CertificatesOperations:
    ...
    def list(
        ...
        :param managed_environment_name: Name of the Managed Environment. Required.
