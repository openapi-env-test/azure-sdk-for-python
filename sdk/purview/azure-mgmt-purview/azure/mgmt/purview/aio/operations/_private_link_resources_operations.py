...
from ...operations._private_link_resources_operations import build_get_by_group_id_request, build_list_by_account_request
T = TypeVar('T')
    ...
    def list_by_account(
        ...
        **kwargs: Any
        ...
        :return: An iterator like instance of either PrivateLinkResourceList or the result of
         cls(response)
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.purview.models.PrivateLinkResourceList]
