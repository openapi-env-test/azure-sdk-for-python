...
from .operations import AccountsOperations, DefaultAccountsOperations, Operations, PrivateEndpointConnectionsOperations, PrivateLinkResourcesOperations
...
class PurviewManagementClient:
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        self._config = PurviewManagementClientConfiguration(credential=credential, subscription_id=subscription_id, **kwargs)
        ...
        self.default_accounts = DefaultAccountsOperations(self._client, self._config, self._serialize, self._deserialize)
