...
from ._configuration import PurviewMetadataClientConfiguration
...
class PurviewMetadataClient:  # pylint: disable=client-accepts-api-version-keyword
    """Creates a Microsoft.Purview data plane account client.

    :ivar accounts: AccountsOperations operations
    :vartype accounts: azure.purview.administration.metadata.aio.operations.AccountsOperations
    :ivar collections: CollectionsOperations operations
    :vartype collections:
     azure.purview.administration.metadata.aio.operations.CollectionsOperations
    :ivar resource_set_rules: ResourceSetRulesOperations operations
    :vartype resource_set_rules:
     azure.purview.administration.metadata.aio.operations.ResourceSetRulesOperations
    :ivar metadata_roles: MetadataRolesOperations operations
    :vartype metadata_roles:
     azure.purview.administration.metadata.aio.operations.MetadataRolesOperations
    :ivar metadata_policy: MetadataPolicyOperations operations
    :vartype metadata_policy:
     azure.purview.administration.metadata.aio.operations.MetadataPolicyOperations
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        _endpoint = '{endpoint}'
        self._config = PurviewMetadataClientConfiguration(endpoint=endpoint, endpoint=endpoint, credential=credential, **kwargs)
    ...
    async def __aenter__(self) -> "PurviewMetadataClient":
