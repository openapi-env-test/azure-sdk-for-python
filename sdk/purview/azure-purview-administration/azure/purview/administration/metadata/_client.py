...
class PurviewMetadataClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype accounts: azure.purview.administration.metadata.operations.AccountsOperations
    :ivar collections: CollectionsOperations operations
    :vartype collections: azure.purview.administration.metadata.operations.CollectionsOperations
    :ivar resource_set_rules: ResourceSetRulesOperations operations
    :vartype resource_set_rules:
     azure.purview.administration.metadata.operations.ResourceSetRulesOperations
    :ivar metadata_roles: MetadataRolesOperations operations
    :vartype metadata_roles:
     azure.purview.administration.metadata.operations.MetadataRolesOperations
    :ivar metadata_policy: MetadataPolicyOperations operations
    :vartype metadata_policy:
     azure.purview.administration.metadata.operations.MetadataPolicyOperations
