...
class Job(DmsBaseObject):
    ...
    :param items_deleted: Number of items deleted by the job as of now
    :type items_deleted: long
    :param total_items_to_delete: Number of items to be deleted by the job in
     total
    :type total_items_to_delete: long
    :param files_copied_counter: Of the items copied by the job as of now, how
     many are files
    :type files_copied_counter: long
    :param files_deleted_counter: Of the items deleted by the job as of now,
     how many are files
    :type files_deleted_counter: long
    :param bytes_copied: Number of bytes actually copied by the job as of now
    :type bytes_copied: long
    :param backup_start_time: Time getting the backup started
    :type backup_start_time: datetime
    :param backup_end_time: Time getting the backup ended
    :type backup_end_time: datetime
    :param estimation_configure_compute_start_time: Time configuring compute
     for estimation stage started
    :type estimation_configure_compute_start_time: datetime
    :param estimation_configure_compute_end_time: Time configuring compute for
     estimation stage ended
    :type estimation_configure_compute_end_time: datetime
    :param directory_parser_start_time: Time enumerating source directory
     started
    :type directory_parser_start_time: datetime
    :param directory_parser_end_time: Time enumerating source directory ended
    :type directory_parser_end_time: datetime
    :param purge_detection_start_time: Time enumerating target directory
     started
    :type purge_detection_start_time: datetime
    :param purge_detection_end_time: Time enumerating target directory ended
    :type purge_detection_end_time: datetime
    :param estimation_start_time: Time estimating files started
    :type estimation_start_time: datetime
    :param estimation_end_time: Time estimating files ended
    :type estimation_end_time: datetime
    :param post_estimation_start_time: Time deleting excess files started
    :type post_estimation_start_time: datetime
    :param post_estimation_end_time: Time deleting excess files ended
    :type post_estimation_end_time: datetime
    :param copy_configure_compute_start_time: Time configuring compute for
     copy stage started
    :type copy_configure_compute_start_time: datetime
    :param copy_configure_compute_end_time: Time configuring compute for copy
     stage ended
    :type copy_configure_compute_end_time: datetime
    :param copy_start_time: Time copying files started
    :type copy_start_time: datetime
    :param copy_end_time: Time copying files ended
    :type copy_end_time: datetime
    :param post_copy_start_time: Time copying logs and creating share snapshot
     started
    :type post_copy_start_time: datetime
    :param post_copy_end_time: Time copying logs and creating share snapshot
     ended
    :type post_copy_end_time: datetime
    :param cleanup_compute_start_time: Time cleaning up compute started
    :type cleanup_compute_start_time: datetime
    :param cleanup_compute_end_time: Time cleaning up compute ended
    :type cleanup_compute_end_time: datetime
    ...
    :param copy_errors: Number of copy errors
    :type copy_errors: long
    :param unsupported_files: Number of unsupported files
    :type unsupported_files: long
    ...
    _attribute_map = {
        ...
        'items_deleted': {'key': 'properties.itemsDeleted', 'type': 'long'},
        'total_items_to_delete': {'key': 'properties.totalItemsToDelete', 'type': 'long'},
        'files_copied_counter': {'key': 'properties.filesCopiedCounter', 'type': 'long'},
        'files_deleted_counter': {'key': 'properties.filesDeletedCounter', 'type': 'long'},
        'bytes_copied': {'key': 'properties.bytesCopied', 'type': 'long'},
        'backup_start_time': {'key': 'properties.backupStartTime', 'type': 'iso-8601'},
        'backup_end_time': {'key': 'properties.backupEndTime', 'type': 'iso-8601'},
        'estimation_configure_compute_start_time': {'key': 'properties.estimationConfigureComputeStartTime', 'type': 'iso-8601'},
        'estimation_configure_compute_end_time': {'key': 'properties.estimationConfigureComputeEndTime', 'type': 'iso-8601'},
        'directory_parser_start_time': {'key': 'properties.directoryParserStartTime', 'type': 'iso-8601'},
        'directory_parser_end_time': {'key': 'properties.directoryParserEndTime', 'type': 'iso-8601'},
        'purge_detection_start_time': {'key': 'properties.purgeDetectionStartTime', 'type': 'iso-8601'},
        'purge_detection_end_time': {'key': 'properties.purgeDetectionEndTime', 'type': 'iso-8601'},
        'estimation_start_time': {'key': 'properties.estimationStartTime', 'type': 'iso-8601'},
        'estimation_end_time': {'key': 'properties.estimationEndTime', 'type': 'iso-8601'},
        'post_estimation_start_time': {'key': 'properties.postEstimationStartTime', 'type': 'iso-8601'},
        'post_estimation_end_time': {'key': 'properties.postEstimationEndTime', 'type': 'iso-8601'},
        'copy_configure_compute_start_time': {'key': 'properties.copyConfigureComputeStartTime', 'type': 'iso-8601'},
        'copy_configure_compute_end_time': {'key': 'properties.copyConfigureComputeEndTime', 'type': 'iso-8601'},
        'copy_start_time': {'key': 'properties.copyStartTime', 'type': 'iso-8601'},
        'copy_end_time': {'key': 'properties.copyEndTime', 'type': 'iso-8601'},
        'post_copy_start_time': {'key': 'properties.postCopyStartTime', 'type': 'iso-8601'},
        'post_copy_end_time': {'key': 'properties.postCopyEndTime', 'type': 'iso-8601'},
        'cleanup_compute_start_time': {'key': 'properties.cleanupComputeStartTime', 'type': 'iso-8601'},
        'cleanup_compute_end_time': {'key': 'properties.cleanupComputeEndTime', 'type': 'iso-8601'},
        ...
        'copy_errors': {'key': 'properties.copyErrors', 'type': 'long'},
        'unsupported_files': {'key': 'properties.unsupportedFiles', 'type': 'long'},
        'error': {'key': 'error', 'type': 'Error'},
    }

    def __init__(self, *, status, start_time, is_cancellable, end_time=None, bytes_processed: int=None, items_processed: int=None, total_bytes_to_process: int=None, total_items_to_process: int=None, items_deleted: int=None, total_items_to_delete: int=None, files_copied_counter: int=None, files_deleted_counter: int=None, bytes_copied: int=None, backup_start_time=None, backup_end_time=None, estimation_configure_compute_start_time=None, estimation_configure_compute_end_time=None, directory_parser_start_time=None, directory_parser_end_time=None, purge_detection_start_time=None, purge_detection_end_time=None, estimation_start_time=None, estimation_end_time=None, post_estimation_start_time=None, post_estimation_end_time=None, copy_configure_compute_start_time=None, copy_configure_compute_end_time=None, copy_start_time=None, copy_end_time=None, post_copy_start_time=None, post_copy_end_time=None, cleanup_compute_start_time=None, cleanup_compute_end_time=None, details=None, data_source_name: str=None, data_sink_name: str=None, copy_errors: int=None, unsupported_files: int=None, error=None, **kwargs) -> None:
        ...
        self.total_items_to_delete = total_items_to_delete
        self.files_copied_counter = files_copied_counter
        self.files_deleted_counter = files_deleted_counter
        self.bytes_copied = bytes_copied
        self.backup_start_time = backup_start_time
        self.backup_end_time = backup_end_time
        self.estimation_configure_compute_start_time = estimation_configure_compute_start_time
        self.estimation_configure_compute_end_time = estimation_configure_compute_end_time
        self.directory_parser_start_time = directory_parser_start_time
        self.directory_parser_end_time = directory_parser_end_time
        self.purge_detection_start_time = purge_detection_start_time
        self.purge_detection_end_time = purge_detection_end_time
        self.estimation_start_time = estimation_start_time
        self.estimation_end_time = estimation_end_time
        self.post_estimation_start_time = post_estimation_start_time
        self.post_estimation_end_time = post_estimation_end_time
        self.copy_configure_compute_start_time = copy_configure_compute_start_time
        self.copy_configure_compute_end_time = copy_configure_compute_end_time
        self.copy_start_time = copy_start_time
        self.copy_end_time = copy_end_time
        self.post_copy_start_time = post_copy_start_time
        self.post_copy_end_time = post_copy_end_time
        self.cleanup_compute_start_time = cleanup_compute_start_time
        self.cleanup_compute_end_time = cleanup_compute_end_time
...
class JobDefinition(DmsBaseObject):
    ...
    :param job_definition_schema_version: Schema version of the job
     definition.
    :type job_definition_schema_version: str
    :param job_definition_state: State of the job definition. Possible values
     include: 'Created', 'Queueing', 'Waiting', 'Running', 'Complete',
     'Cancelling', 'Cancelled', 'Paused'
    :type job_definition_state: str or
     ~azure.mgmt.hybriddatamanager.models.JobDefinitionState
    ...
    _attribute_map = {
        ...
        'job_definition_schema_version': {'key': 'properties.jobDefinitionSchemaVersion', 'type': 'str'},
        'job_definition_state': {'key': 'properties.jobDefinitionState', 'type': 'JobDefinitionState'},
    ...
    def __init__(self, *, data_source_id: str, data_sink_id: str, state, schedules=None, last_modified_time=None, run_location=None, job_definition_schema_version: str=None, job_definition_state=None, user_confirmation="NotRequired", data_service_input=None, customer_secrets=None, **kwargs) -> None:
        ...
        self.job_definition_schema_version = job_definition_schema_version
        self.job_definition_state = job_definition_state
