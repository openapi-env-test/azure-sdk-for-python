...
class Job(DmsBaseObject):
    ...
    def __init__(self, **kwargs):
        ...
        self.items_deleted = kwargs.get('items_deleted', None)
        self.total_items_to_delete = kwargs.get('total_items_to_delete', None)
        self.files_copied_counter = kwargs.get('files_copied_counter', None)
        self.files_deleted_counter = kwargs.get('files_deleted_counter', None)
        self.bytes_copied = kwargs.get('bytes_copied', None)
        self.backup_start_time = kwargs.get('backup_start_time', None)
        self.backup_end_time = kwargs.get('backup_end_time', None)
        self.estimation_configure_compute_start_time = kwargs.get('estimation_configure_compute_start_time', None)
        self.estimation_configure_compute_end_time = kwargs.get('estimation_configure_compute_end_time', None)
        self.directory_parser_start_time = kwargs.get('directory_parser_start_time', None)
        self.directory_parser_end_time = kwargs.get('directory_parser_end_time', None)
        self.purge_detection_start_time = kwargs.get('purge_detection_start_time', None)
        self.purge_detection_end_time = kwargs.get('purge_detection_end_time', None)
        self.estimation_start_time = kwargs.get('estimation_start_time', None)
        self.estimation_end_time = kwargs.get('estimation_end_time', None)
        self.post_estimation_start_time = kwargs.get('post_estimation_start_time', None)
        self.post_estimation_end_time = kwargs.get('post_estimation_end_time', None)
        self.copy_configure_compute_start_time = kwargs.get('copy_configure_compute_start_time', None)
        self.copy_configure_compute_end_time = kwargs.get('copy_configure_compute_end_time', None)
        self.copy_start_time = kwargs.get('copy_start_time', None)
        self.copy_end_time = kwargs.get('copy_end_time', None)
        self.post_copy_start_time = kwargs.get('post_copy_start_time', None)
        self.post_copy_end_time = kwargs.get('post_copy_end_time', None)
        self.cleanup_compute_start_time = kwargs.get('cleanup_compute_start_time', None)
        self.cleanup_compute_end_time = kwargs.get('cleanup_compute_end_time', None)
        self.details = kwargs.get('details', None)
        self.data_source_name = kwargs.get('data_source_name', None)
        self.data_sink_name = kwargs.get('data_sink_name', None)
        self.copy_errors = kwargs.get('copy_errors', None)
        self.unsupported_files = kwargs.get('unsupported_files', None)
...
class JobDefinition(DmsBaseObject):
    ...
    def __init__(self, **kwargs):
        ...
        self.job_definition_schema_version = kwargs.get('job_definition_schema_version', None)
        self.job_definition_state = kwargs.get('job_definition_state', None)
