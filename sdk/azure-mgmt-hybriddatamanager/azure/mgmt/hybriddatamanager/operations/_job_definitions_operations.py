...
class JobDefinitionsOperations(object):
    ...
    :ivar api_version: The API Version. Constant value: "2021-05-01".
    """
    ...
    def cancel(
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    cancel.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/cancel'}


    def _check_status_initial(
            self, data_service_name, job_definition_name, resource_group_name, data_manager_name, custom_headers=None, raw=False, **operation_config):
        # Construct URL
    ...
    def check_status(
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = self._check_status_initial(
            data_service_name=data_service_name,
            job_definition_name=job_definition_name,
            resource_group_name=resource_group_name,
            data_manager_name=data_manager_name,
        ...
        return LROPoller(self._client, raw_result, get_long_running_output, polling_method)
    check_status.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/checkStatus'}
    ...
    def retry(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    retry.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/retryjob'}
    ...
    def skip(
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    skip.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridData/dataManagers/{dataManagerName}/dataServices/{dataServiceName}/jobDefinitions/{jobDefinitionName}/skipjob'}
