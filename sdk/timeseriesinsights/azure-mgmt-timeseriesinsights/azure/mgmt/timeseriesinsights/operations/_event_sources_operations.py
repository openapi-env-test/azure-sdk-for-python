...
class EventSourcesOperations(object):
    ...
    def list_by_environment(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of EventSourceResource
        :rtype:
         ~azure.mgmt.timeseriesinsights.models.EventSourceResourcePaged[~azure.mgmt.timeseriesinsights.models.EventSourceResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.EventSourceResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
