...
class AccessPoliciesOperations(object):
    ...
    def list_by_environment(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: An iterator like instance of AccessPolicyResource
        :rtype:
         ~azure.mgmt.timeseriesinsights.models.AccessPolicyResourcePaged[~azure.mgmt.timeseriesinsights.models.AccessPolicyResource]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        if raw:
            header_dict = {}
        deserialized = models.AccessPolicyResourcePaged(internal_paging, self._deserialize.dependencies, header_dict)
