...
class IdentityData(Model):
    ...
    :param tenant_id: The tenant Id header.
    :type tenant_id: str
    :param principal_id: The principal Id header.
    :type principal_id: str
    :param type: Required. The Identity type, can be
    ...
    def __init__(self, *, type: str, tenant_id: str=None, principal_id: str=None, **kwargs) -> None:
...
class PrivateLinkResource(Model):
    ...
    def __init__(self, *, id: str=None, name: str=None, type: str=None, group_id: str=None, required_members=None, required_zone_names=None, **kwargs) -> None:
...
class PrivateLinkServiceConnectionState(Model):
    ...
    :param status: Possible values include: 'Pending', 'Approved', 'Rejected',
     'Disconnected'
    :type status: str or
     ~azure.mgmt.recoveryservices.models.PrivateEndpointConnectionStatus
    :param description:
    :type description: str
    :param actions_required:
