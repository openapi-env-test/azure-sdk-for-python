...
class GetOperations:
    ...
    async def integration_runtime_start(
        ...
        **kwargs: Any
        ...
        cls = kwargs.pop("cls", None)  # type: ClsType[_models.IntegrationRuntimeOperationStatus]
    ...
    integration_runtime_start.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/integrationRuntimes/{integrationRuntimeName}/start/operationstatuses/{integrationRuntimeOperationId}"}  # type: ignore
