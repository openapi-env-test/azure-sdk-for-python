...
class Identity(TrackedResource):
    ...
    :param test_new_property: for test only.
    :type test_new_property: str
    """
    ...
    _attribute_map = {
        ...
        'test_new_property': {'key': 'properties.testNewProperty', 'type': 'str'},
    }
    ...
    def __init__(
        ...
        *,
        location: str,
        tags: Optional[Dict[str, str]] = None,
        test_new_property: Optional[str] = None,
        **kwargs
    ):
        ...
        self.client_id = None
        self.test_new_property = test_new_property
