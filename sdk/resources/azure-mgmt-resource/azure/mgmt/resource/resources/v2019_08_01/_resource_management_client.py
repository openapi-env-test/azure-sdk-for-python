...
class ResourceManagementClient(SDKClient):
    ...
    :param api_version11: The API version to use for this operation.
    :type api_version11: str
    :param str base_url: Service URL
    """

    def __init__(
            self, credentials, subscription_id, subscription_id1, api_version11, base_url=None):

        self.config = ResourceManagementClientConfiguration(credentials, subscription_id, subscription_id1, api_version11, base_url)
