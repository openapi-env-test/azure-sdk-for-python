...
class SDKReleasePlannerTestClientOperationsMixin(SDKReleasePlannerTestClientMixinABC):
    ...
    async def list_collections(self, **kwargs: Any) -> List[_models.CollectionModel]:
        ...
        :rtype: list[~azure.sdkreleaseplannertest.models.CollectionModel]
    ...
    def list_ledger_entries(self, **kwargs: Any) -> AsyncIterable["_models.LedgerEntry"]:
        ...
        :return: An iterator like instance of LedgerEntry. The LedgerEntry is compatible with
         MutableMapping
        :rtype:
         ~azure.core.async_paging.AsyncItemPaged[~azure.sdkreleaseplannertest.models.LedgerEntry]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        _headers = kwargs.pop("headers", {}) or {}
        _params = kwargs.pop("params", {}) or {}
    ...
    async def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~azure.sdkreleaseplannertest.models.LedgerEntry or JSON
    ...
    async def create_ledger_entry(  # pylint: disable=inconsistent-return-statements
        ...
        :type body: ~azure.sdkreleaseplannertest.models.LedgerEntry or JSON or IO
        :keyword collection_id: The collection id. Default value is None.
        :paramtype collection_id: str
    ...
    async def get_ledger_entry(
        ...
        :rtype: ~azure.sdkreleaseplannertest.models.LedgerEntry
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def get_receipt(self, transaction_id: str, **kwargs: Any) -> _models.TransactionReceipt:
        ...
        :rtype: ~azure.sdkreleaseplannertest.models.TransactionReceipt
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def get_transaction_status(self, transaction_id: str, **kwargs: Any) -> _models.TransactionStatus:
        ...
        :rtype: ~azure.sdkreleaseplannertest.models.TransactionStatus
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def get_user(self, user_id: str, **kwargs: Any) -> _models.LedgerUser:
        ...
        :rtype: ~azure.sdkreleaseplannertest.models.LedgerUser
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        error_map = {
            401: ClientAuthenticationError,
    ...
    async def create_or_update_user(
        ...
        **kwargs: Any
        ...
        :type user_id: str
        :param body: Required.
        :type body: ~azure.sdkreleaseplannertest.models.LedgerUser or JSON
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
    ...
    async def create_or_update_user(
        ...
        :type user_id: str
        :param body: Is either a model type or a IO type. Required.
        :type body: ~azure.sdkreleaseplannertest.models.LedgerUser or JSON or IO
