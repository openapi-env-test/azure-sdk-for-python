...
class LedgerUser(_model_base.Model):
    ...
    :vartype assigned_role: str or ~azure.sdkreleaseplannertest.models.LedgerUserRole
    """
...
class PagedLedgerEntries(_model_base.Model):
    ...
    :vartype entries: list[~azure.sdkreleaseplannertest.models.LedgerEntry]
    :ivar state: State of the ledger query. Required. Known values are: "Loading" and "Ready".
    :vartype state: str or ~azure.sdkreleaseplannertest.models.LedgerQueryState
...
class TransactionReceipt(_model_base.Model):
    ...
    :vartype receipt: ~azure.sdkreleaseplannertest.models.ReceiptContents
...
class TransactionStatus(_model_base.Model):
    ...
    :vartype state: str or ~azure.sdkreleaseplannertest.models.TransactionState
    :ivar transaction_id: The transaction ID. Required.
    :vartype transaction_id: str
    """
