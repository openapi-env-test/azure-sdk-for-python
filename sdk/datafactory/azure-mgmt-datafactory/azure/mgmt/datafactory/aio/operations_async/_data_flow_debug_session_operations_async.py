...
class DataFlowDebugSessionOperations:
    ...
    async def create(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.datafactory.models.CreateDataFlowDebugSessionResponse
    ...
    def query_by_factory(
        ...
        **kwargs
        ...
        :type factory_name: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of QueryDataFlowDebugSessionsResponse or the result of cls(response)
    ...
    async def execute_command(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.datafactory.models.DataFlowDebugCommandResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.DataFlowDebugCommandResponse"]
