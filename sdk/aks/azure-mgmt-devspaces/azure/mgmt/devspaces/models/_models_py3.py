...
class Controller(TrackedResource):
    ...
    :param host_endpoint_type: The endpoint type to be exposed for a Azure Dev
     Spaces Controller. Possible values include: 'Public', 'Private', 'None'
    :type host_endpoint_type: str or
     ~azure.mgmt.devspaces.models.HostEndpointType
    ...
    _attribute_map = {
        ...
        'host_endpoint_type': {'key': 'properties.hostEndpointType', 'type': 'str'},
    ...
    def __init__(self, *, target_container_host_resource_id: str, target_container_host_credentials_base64: str, sku, tags=None, location: str=None, host_endpoint_type=None, **kwargs) -> None:
        super(Controller, self).__init__(tags=tags, location=location, **kwargs)
        self.provisioning_state = None
        self.host_suffix = None
        self.host_endpoint_type = host_endpoint_type
