...
class CertificateSet(Model):
    ...
    :param certificates: Required. Three certificates needed from customer
    :type certificates:
     list[~azure.keyvault.v7_2.models.SecurityDomainCertificateItem]
    """

    _validation = {
        'certificates': {'required': True, 'max_items': 3, 'min_items': 3, 'unique': True},
    }
...
class SecurityDomainCertificateItem(Model):
    ...
    :param value: Required. Customer generated certificate containing public
     key in JWK format
    :type value: ~azure.keyvault.v7_2.models.SecurityDomainJsonWebKey1
    """
    ...
    _attribute_map = {
        'value': {'key': 'value', 'type': 'SecurityDomainJsonWebKey1'},
    }
...
class SecurityDomainJsonWebKey1(Model):
    ...
    :param kty: Required. JsonWebKey Key Type (kty), as defined in
     ...
     security domain this value must be RSA. Possible values include: 'RSA',
     'RSA-HSM'
    :type kty: str or ~azure.keyvault.v7_2.models.SecurityDomainJsonWebKey
    ...
    def __init__(self, *, kid: str, kty, key_ops, n: str, e: str, x5c, x5t_s256: str, use: str=None, x5t: str=None, alg: str=None, **kwargs) -> None:
        super(SecurityDomainJsonWebKey1, self).__init__(**kwargs)
        self.kid = kid
        self.kty = kty
        self.key_ops = key_ops
        self.n = n
...
class SecurityDomainOperationStatus(Model):
    ...
    :param status: operation status. Possible values include: 'Success',
     'InProgress', 'Failed'
    :type status: str or ~azure.keyvault.v7_2.models.OperationStatus
...
class TransferKey(Model):
    ...
    :param transfer_key: Required.
    :type transfer_key: ~azure.keyvault.v7_2.models.SecurityDomainJsonWebKey1
    """
    ...
    _attribute_map = {
        'transfer_key': {'key': 'transfer_key', 'type': 'SecurityDomainJsonWebKey1'},
    }

    def __init__(self, *, transfer_key, **kwargs) -> None:
