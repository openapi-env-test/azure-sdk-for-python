...
def build_list_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providers/Microsoft.Blockchain/skus")
...
class SkusOperations:
    ...
    @distributed_trace
    def list(self, **kwargs: Any) -> _models.ResourceTypeSkuCollection:
