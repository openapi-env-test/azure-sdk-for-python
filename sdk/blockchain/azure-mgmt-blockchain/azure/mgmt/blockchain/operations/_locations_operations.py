...
def build_list_consortiums_request(location_name: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class LocationsOperations:
    ...
    def check_name_availability(
        ...
        **kwargs: Any
        ...
        :param name_availability_request: Name availability request payload. Default value is None.
        :type name_availability_request: ~azure.mgmt.blockchain.models.NameAvailabilityRequest
    ...
    def check_name_availability(
        self,
        location_name: str,
        name_availability_request: Optional[IO] = None,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models.NameAvailability:
    ...
    def check_name_availability(
        self,
        location_name: str,
        name_availability_request: Optional[Union[_models.NameAvailabilityRequest, IO]] = None,
        **kwargs: Any
    ) -> _models.NameAvailability:
        """To check whether a resource name is available.
        ...
        :type name_availability_request: ~azure.mgmt.blockchain.models.NameAvailabilityRequest or IO
    ...
    @distributed_trace
    def list_consortiums(self, location_name: str, **kwargs: Any) -> _models.ConsortiumCollection:
