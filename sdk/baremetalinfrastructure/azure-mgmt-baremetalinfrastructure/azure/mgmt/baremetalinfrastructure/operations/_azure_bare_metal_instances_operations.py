...
def build_list_by_subscription_request(subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2021-08-10"))  # type: str
...
class AzureBareMetalInstancesOperations:
    ...
    _update_initial.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances/{azureBareMetalInstanceName}"}  # type: ignore
    ...
    def begin_update(
        ...
        **kwargs: Any
    ) -> LROPoller[_models.AzureBareMetalInstance]:
        ...
        :return: An instance of LROPoller that returns either AzureBareMetalInstance or the result of
         cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    begin_update.metadata = {"url": "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BareMetalInfrastructure/bareMetalInstances/{azureBareMetalInstanceName}"}  # type: ignore
