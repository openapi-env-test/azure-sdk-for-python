...
class AzureBareMetalInstancesOperations:
    ...
    async def begin_update(
        ...
        **kwargs: Any
    ) -> AsyncLROPoller[_models.AzureBareMetalInstance]:
        ...
        :return: An instance of AsyncLROPoller that returns either AzureBareMetalInstance or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.AsyncLROPoller[~azure.mgmt.baremetalinfrastructure.models.AzureBareMetalInstance]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
