...
class DscConfigurationOperations(object):
    ...
    def create_or_update(
        ...
        automation_account_name,  # type: str
        configuration_name,  # type: str
        parameters,  # type: "models.DscConfigurationCreateOrUpdateParameters"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DscConfiguration"
    ...
    def update(
        ...
        automation_account_name,  # type: str
        configuration_name,  # type: str
        parameters=None,  # type: Optional["models.DscConfigurationUpdateParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.DscConfiguration"
        """Create the configuration identified by configuration name.
    ...
    def list_by_automation_account(
        ...
        **kwargs  # type: Any
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of DscConfigurationListResult or the result of cls(response)
