...
class WebhookOperations:
    ...
    async def generate_uri(self, resource_group_name: str, automation_account_name: str, **kwargs) -> str:
    ...
    async def delete(self, resource_group_name: str, automation_account_name: str, webhook_name: str, **kwargs) -> None:
    ...
    async def get(
        self, resource_group_name: str, automation_account_name: str, webhook_name: str, **kwargs
    ) -> "_models.Webhook":
