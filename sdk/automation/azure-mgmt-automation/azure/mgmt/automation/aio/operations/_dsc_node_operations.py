...
class DscNodeOperations:
    ...
    async def delete(self, resource_group_name: str, automation_account_name: str, node_id: str, **kwargs) -> None:
    ...
    async def get(
        self, resource_group_name: str, automation_account_name: str, node_id: str, **kwargs
    ) -> "_models.DscNode":
