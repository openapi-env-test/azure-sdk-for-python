...
class WatcherOperations:
    ...
    async def get(
        self, resource_group_name: str, automation_account_name: str, watcher_name: str, **kwargs
    ) -> "_models.Watcher":
    ...
    async def delete(self, resource_group_name: str, automation_account_name: str, watcher_name: str, **kwargs) -> None:
    ...
    async def start(self, resource_group_name: str, automation_account_name: str, watcher_name: str, **kwargs) -> None:
    ...
    async def stop(self, resource_group_name: str, automation_account_name: str, watcher_name: str, **kwargs) -> None:
        """Resume the watcher identified by watcher name.
