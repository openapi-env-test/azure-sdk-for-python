...
class DscCompilationJobOperations:
    ...
    create.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Automation/automationAccounts/{automationAccountName}/compilationjobs/{compilationJobName}'}  # type: ignore
    ...
    def list_by_automation_account(
        ...
        **kwargs
        ...
        :type filter: str
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of DscCompilationJobListResult or the result of cls(response)
