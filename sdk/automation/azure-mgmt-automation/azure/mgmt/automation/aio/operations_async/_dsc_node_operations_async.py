...
class DscNodeOperations:
    ...
    async def update(
        ...
        properties: Optional["models.DscNodeUpdateParametersProperties"] = None,
        **kwargs
    ) -> "models.DscNode":
        """Update the dsc node.
        ...
        _dsc_node_update_parameters = models.DscNodeUpdateParameters(node_id=dsc_node_update_parameters_node_id, properties=properties)
        api_version = "2018-01-15"
    ...
    def list_by_automation_account(
        ...
        **kwargs
    ) -> AsyncIterable["models.DscNodeListResult"]:
        ...
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of DscNodeListResult or the result of cls(response)
