...
class AutomationAccountCreateOrUpdateParameters(Model):
    ...
    def __init__(self, *, sku=None, encryption=None, name: str=None, location: str=None, identity=None, tags=None, **kwargs) -> None:
...
class EncryptionProperties(Model):
    ...
    def __init__(self, *, key_vault_properties=None, key_source=None, **kwargs) -> None:
