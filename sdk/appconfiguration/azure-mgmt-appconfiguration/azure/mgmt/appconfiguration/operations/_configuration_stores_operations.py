...
class ConfigurationStoresOperations(object):
    ...
    def list_by_resource_group(
        ...
        :rtype: ~azure.mgmt.appconfiguration.models.ErrorResponse[None]
        :raises:
         :class:`ErrorResponseException<azure.mgmt.appconfiguration.models.ErrorResponseException>`
        """
        def prepare_request(next_link=None):
        ...
        if raw:
            header_dict = {}
        deserialized = models.ErrorResponse(internal_paging, self._deserialize.dependencies, header_dict)
    ...
    def get_abcdef(
        ...
        :rtype: ~azure.mgmt.appconfiguration.models.ErrorResponse or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<azure.mgmt.appconfiguration.models.ErrorResponseException>`
        """
        # Construct URL
        url = self.get_abcdef.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
    ...
    get_abcdef.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}'}
