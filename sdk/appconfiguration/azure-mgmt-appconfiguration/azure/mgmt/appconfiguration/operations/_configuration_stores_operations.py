...
def build_list_request(subscription_id: str, *, skip_token: Optional[str] = None, **kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2011-01-01"))  # type: str
...
class ConfigurationStoresOperations:
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param config_store_update_parameters: The parameters for updating a configuration store. Is
         either a model type or a IO type. Required.
        :type config_store_update_parameters:
         ~azure.mgmt.appconfiguration.models.ConfigurationStoreUpdateParameters or IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_key_value(
        ...
        **kwargs: Any
        ...
        :type config_store_name: str
        :param list_key_value_parameters: The parameters for retrieving a key-value. Required.
        :type list_key_value_parameters: IO
        :keyword content_type: Body Parameter content-type. Content type parameter for binary body.
         Default value is "application/json".
        :paramtype content_type: str
        :keyword callable cls: A custom type or function that will be passed the direct response
    ...
    def list_key_value(
        ...
        resource_group_name: str,
        config_store_name: str,
        list_key_value_parameters: Union[_models.ListKeyValueParameters, IO],
        **kwargs: Any
    ) -> _models.KeyValue:
        """Lists a configuration store key-value.
        ...
        :param config_store_name: The name of the configuration store. Required.
        :type config_store_name: str
        :param list_key_value_parameters: The parameters for retrieving a key-value. Is either a model
         type or a IO type. Required.
        :type list_key_value_parameters: ~azure.mgmt.appconfiguration.models.ListKeyValueParameters or
         IO
        :keyword content_type: Body Parameter content-type. Known values are: 'application/json'.
         Default value is None.
        :paramtype content_type: str
        ...
        _json = None
        _content = None
        if isinstance(list_key_value_parameters, (IO, bytes)):
            _content = list_key_value_parameters
        else:
