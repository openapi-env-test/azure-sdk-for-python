...
class KeyValuesOperations:
    ...
    def list_by_configuration_store(
        ...
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.appconfiguration.models.KeyValue]
    ...
    async def create_or_update(
        ...
        **kwargs: Any
        ...
        :type key_value_parameters: ~azure.mgmt.appconfiguration.models.KeyValue or IO
