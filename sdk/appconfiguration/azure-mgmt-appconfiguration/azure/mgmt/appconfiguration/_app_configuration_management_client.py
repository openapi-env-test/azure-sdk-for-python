...
from .operations import ConfigurationStoresOperations, Operations, PrivateEndpointConnectionsOperations, PrivateLinkResourcesOperations
...
class AppConfigurationManagementClient:
    ...
    :type base_url: str
    :keyword api_version: Api Version. Default value is "2011-01-01". Note that overriding this
