...
def build_list_request(
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/subscriptions/{subscriptionId}/providersss/Microsoft.AppConfiguration/configurationStores")  # pylint: disable=line-too-long
...
class ConfigurationStoresOperations:
    ...
    list.metadata = {'url': "/subscriptions/{subscriptionId}/providersss/Microsoft.AppConfiguration/configurationStores"}  # type: ignore
