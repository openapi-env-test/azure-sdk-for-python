...
def build_validate_request(resource_uri: str, linker_name: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/{resourceUri}/providers/Microsoft.ServiceLinker/linkers/validateLinker")
    path_format_arguments = {
        "resourceUri": _SERIALIZER.url("resource_uri", resource_uri, "str", skip_quote=True),
        "linkerName": _SERIALIZER.url("linker_name", linker_name, "str"),
    }
...
class LinkerOperations:
    ...
    _validate_initial.metadata = {"url": "/{resourceUri}/providers/Microsoft.ServiceLinker/linkers/validateLinker"}
    ...
    begin_validate.metadata = {"url": "/{resourceUri}/providers/Microsoft.ServiceLinker/linkers/validateLinker"}
