...
def build_list_request(location: str, subscription_id: str, **kwargs: Any) -> HttpRequest:
    ...
    api_version = kwargs.pop("api_version", _params.pop("api-version", "2022-11-11"))  # type: str
...
class SkusOperations:
    ...
    list.metadata = {"url": "/subscriptions/{subscriptionId}/providers/Microsoft.Kusto/locations/{location}/skus"}  # type: ignore
