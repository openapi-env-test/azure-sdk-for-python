...
class LinkTargetsOperations(object):
    """LinkTargetsOperations operations.
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.OperationalInsights/linkTargets'}
