...
from .operations import LinkTargetsOperations
...
class OperationalInsightsManagementClient(SDKClient):
    ...
    :ivar link_targets: LinkTargets operations
    :vartype link_targets: azure.mgmt.loganalytics.operations.LinkTargetsOperations
    ...
    def __init__(
        ...
        self.saved_searches = SavedSearchesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.link_targets = LinkTargetsOperations(
            self._client, self.config, self._serialize, self._deserialize)
