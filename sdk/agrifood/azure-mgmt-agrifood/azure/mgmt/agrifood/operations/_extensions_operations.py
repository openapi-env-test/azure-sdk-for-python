...
class ExtensionsOperations:
    ...
    create.metadata = {
        "url": "/subscriptions/{subscriptionId}/resourcesGroups/{resourceGroupName}/providers/Microsoft.AgFoodPlatform/farmBeats/{farmBeatsResourceName}/extensions/{extensionId}"
    }
