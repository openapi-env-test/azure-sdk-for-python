...
class FarmBeats(TrackedResource):
    ...
    :ivar provisioning_state_sz: FarmBeats instance provisioning state. Known values are:
     "Succeeded" and "Failed".
    :vartype provisioning_state_sz: str or ~azure.mgmt.agrifood.models.ProvisioningState
    """
    ...
    _validation = {
        ...
        "provisioning_state_sz": {"readonly": True},
    }
    ...
    _attribute_map = {
        ...
        "provisioning_state_sz": {"key": "properties.provisioningStateSz", "type": "str"},
    }
    ...
    def __init__(self, *, location: str, tags: Optional[Dict[str, str]] = None, **kwargs: Any) -> None:
        ...
        self.provisioning_state_sz = None
...
class FarmBeatsListResponse(_serialization.Model):
    ...
    :ivar next_link: Continuation link (absolute URI) to the next page of result in the list.
    :vartype next_link: str
    """
