...
class LinkedWorkspace(Model):
    ...
    :type link_name: str
    :ivar link_type: The type of the linked workspace. Possible values
     include: 'Synapse'
    :vartype link_type: str or
     ~azure.mgmt.machinelearningservices.models.LinkType
    :param subscription_id: SubscriptionId of the target of the linked
     workspace.
    :type subscription_id: str
    :param resource_group_name: Resource group name of the target of the
     linked workspace.
    :type resource_group_name: str
    :param provider_namespace: Resource provider namespace of the target of
    ...
    :param workspace_name: Resource name of the target of the linked
     workspace.
    :type workspace_name: str
    :param resource_id: ResourceId of the target of the linked workspace.
    :type resource_id: str
    :param user_assigned_identity_resource_id: ResourceId of the user assigned
     identity that used to communicate with the linked workspace.
    ...
    def __init__(self, *, link_name: str=None, subscription_id: str=None, resource_group_name: str=None, provider_namespace: str=None, resource_type: str=None, workspace_name: str=None, resource_id: str=None, user_assigned_identity_resource_id: str=None, **kwargs) -> None:
...
class LinkedWorkspaceCreateDto(Model):
    ...
    :type resource_id: str
    :param user_assigned_identity_resource_id: ResourceId of the user assigned
     identity for the linked workspace
    :type user_assigned_identity_resource_id: str
    """
    ...
    def __init__(self, *, link_name: str=None, resource_id: str=None, user_assigned_identity_resource_id: str=None, **kwargs) -> None:
...
class LinkedWorkspaceUpdateDto(Model):
    ...
    def __init__(self, *, user_assigned_identity_resource_id: str=None, **kwargs) -> None:
...
class Workspace(Resource):
    ...
    :param linked_workspaces: Dictionary that contains all linked workspaces
     in the AML workspace, with resourceId of the linked workspace as key.
    :type linked_workspaces: dict[str,
     ~azure.mgmt.machinelearningservices.models.LinkedWorkspace]
    """
    ...
    def __init__(self, *, identity=None, location: str=None, tags=None, sku=None, description: str=None, friendly_name: str=None, key_vault: str=None, application_insights: str=None, container_registry: str=None, storage_account: str=None, discovery_url: str=None, encryption=None, hbi_workspace: bool=False, image_build_compute: str=None, allow_public_access_when_behind_vnet: bool=False, shared_private_link_resources=None, linked_workspaces=None, **kwargs) -> None:
