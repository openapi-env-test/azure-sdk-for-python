...
class BindOptions(_serialization.Model):
    ...
    :ivar selinux: Mention the selinux.
    :vartype selinux: str
    """

    _attribute_map = {
        "propagation": {"key": "propagation", "type": "str"},
        "create_host_path": {"key": "create_host_path", "type": "bool"},
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword selinux: Mention the selinux.
...
class EnvironmentVariable(_serialization.Model):
    ...
    :ivar type: Type of the Environment Variable. Possible values are: local - For local variable,
     azureml - For azureml variables. Known values are: "local" and "azureml".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword type: Type of the Environment Variable. Possible values are: local - For local
         variable, azureml - For azureml variables. Known values are: "local" and "azureml".
...
class VolumeDefinition(_serialization.Model):
    ...
    :ivar read_only: Indicate whether to mount volume as read_only.
    :vartype read_only: bool
    :ivar source: Source of the mount.
    :vartype source: str
    :ivar target: Target of the mount.
    :vartype target: str
    ...
    def __init__(
        self,
        *,
        type: Union[str, "_models.VolumeDefinitionType"] = "volume",
        ...
        **kwargs
        ...
        :keyword read_only: Indicate whether to mount volume as read_only.
        :paramtype read_only: bool
        :keyword source: Source of the mount.
        :paramtype source: str
        :keyword target: Target of the mount.
        :paramtype target: str
