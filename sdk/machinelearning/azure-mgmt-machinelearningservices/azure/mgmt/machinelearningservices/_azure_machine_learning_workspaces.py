...
from .operations import LinkedWorkspacesOperations
from . import models
...
class AzureMachineLearningWorkspaces(AzureMachineLearningWorkspacesOperationsMixin, SDKClient):
    ...
    :ivar linked_workspaces: LinkedWorkspaces operations
    :vartype linked_workspaces: azure.mgmt.machinelearningservices.operations.LinkedWorkspacesOperations
    ...
    def __init__(
        ...
        self.private_link_resources = PrivateLinkResourcesOperations(
            self._client, self.config, self._serialize, self._deserialize)
        self.linked_workspaces = LinkedWorkspacesOperations(
            self._client, self.config, self._serialize, self._deserialize)
