...
class PerimeterAssociableResourceTypesOperations:
    ...
    async def get(
        ...
        **kwargs: Any
        ...
        request = build_perimeter_associable_resource_types_get_request(
            subscription_id=self._config.subscription_id,
            location=location,
            template_url=self.get.metadata['url'],
        )
