...
class SubnetsOperations:
    ...
    async def _prepare_network_policies_initial(
        ...
        network_intent_policy_configurations: Optional[List["models.NetworkIntentPolicyConfiguration"]] = None,
        **kwargs
    ) -> None:
        cls = kwargs.pop('cls', None)  # type: ClsType[None]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def prepare_network_policies(
        ...
        **kwargs
        ...
        :type network_intent_policy_configurations: list[~azure.mgmt.network.v2019_09_01.models.NetworkIntentPolicyConfiguration]
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.AsyncPollingMethod
