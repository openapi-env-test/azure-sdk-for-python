...
class VirtualNetworkGatewaysOperations(object):
    ...
    def _generatevpnclientpackage_initial(
        ...
        resource_group_name,  # type: str
        virtual_network_gateway_name,  # type: str
        processor_architecture=None,  # type: Optional[Union[str, "models.ProcessorArchitecture"]]
        **kwargs  # type: Any
    ):
        # type: (...) -> str
        ...
        _parameters = models.VpnClientParameters(processor_architecture=processor_architecture)
        api_version = "2015-06-15"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'VpnClientParameters')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def begin_generatevpnclientpackage(
     ...
     and 'X86'.
        :type processor_architecture: str or ~azure.mgmt.network.v2015_06_15.models.ProcessorArchitecture
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
