...
class ExpressRouteCrossConnectionsOperations:
    ...
    async def list_arp_table(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.ExpressRouteCircuitsArpTableListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExpressRouteCircuitsArpTableListResult"]
    ...
    async def list_routes_table_summary(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.ExpressRouteCrossConnectionsRoutesTableSummaryListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExpressRouteCrossConnectionsRoutesTableSummaryListResult"]
    ...
    async def list_routes_table(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.ExpressRouteCircuitsRoutesTableListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ExpressRouteCircuitsRoutesTableListResult"]
