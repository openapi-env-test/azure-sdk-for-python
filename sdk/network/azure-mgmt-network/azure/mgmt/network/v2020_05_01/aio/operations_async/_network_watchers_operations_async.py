...
class NetworkWatchersOperations:
    ...
    async def verify_ip_flow(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.VerificationIPFlowResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VerificationIPFlowResult"]
    ...
    async def get_next_hop(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.NextHopResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NextHopResult"]
    ...
    async def get_vm_security_rules(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.SecurityGroupViewResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SecurityGroupViewResult"]
    ...
    async def get_troubleshooting(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.TroubleshootingResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.TroubleshootingResult"]
    ...
    async def set_flow_log_configuration(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.FlowLogInformation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.FlowLogInformation"]
    ...
    async def check_connectivity(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.ConnectivityInformation
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.ConnectivityInformation"]
    ...
    async def get_azure_reachability_report(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.AzureReachabilityReport
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AzureReachabilityReport"]
    ...
    async def list_available_providers(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.AvailableProvidersList
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.AvailableProvidersList"]
    ...
    async def get_network_configuration_diagnostic(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.NetworkConfigurationDiagnosticResponse
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.NetworkConfigurationDiagnosticResponse"]
