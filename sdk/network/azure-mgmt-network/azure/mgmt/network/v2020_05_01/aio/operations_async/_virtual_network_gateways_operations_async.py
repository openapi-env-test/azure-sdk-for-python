...
class VirtualNetworkGatewaysOperations:
    ...
    async def get_bgp_peer_status(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.BgpPeerStatusListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.BgpPeerStatusListResult"]
    ...
    async def get_learned_routes(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.GatewayRouteListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.GatewayRouteListResult"]
    ...
    async def set_vpnclient_ipsec_parameters(
     ...
     of Virtual Network Gateway P2S client operation through Network resource provider.
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.VpnClientIPsecParameters
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VpnClientIPsecParameters"]
    ...
    async def get_vpnclient_connection_health(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.VpnClientConnectionHealthDetailListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.VpnClientConnectionHealthDetailListResult"]
