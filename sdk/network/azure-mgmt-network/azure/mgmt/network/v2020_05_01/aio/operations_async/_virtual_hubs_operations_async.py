...
class VirtualHubsOperations:
    ...
    async def _get_effective_virtual_hub_routes_initial(
        ...
        resource_group_name: str,
        virtual_hub_name: str,
        resource_id: Optional["models.Resource"] = None,
        ...
        **kwargs
        ...
        _effective_routes_parameters = models.EffectiveRoutesParameters(resource_id=resource_id, virtual_wan_resource_type=virtual_wan_resource_type)
        api_version = "2020-05-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        if _effective_routes_parameters is not None:
            body_content = self._serialize.body(_effective_routes_parameters, 'EffectiveRoutesParameters')
        else:
            body_content = None
        body_content_kwargs['content'] = body_content
    ...
    async def get_effective_virtual_hub_routes(
        self,
        resource_group_name: str,
        virtual_hub_name: str,
        resource_id: Optional["models.Resource"] = None,
     ...
     ExpressRouteConnection, HubVirtualNetworkConnection, VpnConnection and P2SConnection.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    get_effective_virtual_hub_routes.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualHubs/{virtualHubName}/effectiveRoutes'}  # type: ignore
