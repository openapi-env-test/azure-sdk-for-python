...
class NetworkInterfacesOperations:
    ...
    async def get_effective_route_table(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.EffectiveRouteListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EffectiveRouteListResult"]
    ...
    async def list_effective_network_security_groups(
        ...
        **kwargs
        ...
        :rtype: ~azure.mgmt.network.v2020_05_01.models.EffectiveNetworkSecurityGroupListResult
        :raises ~azure.core.exceptions.HttpResponseError:
        """
        polling = kwargs.pop('polling', True)  # type: Union[bool, AsyncPollingMethod]
        cls = kwargs.pop('cls', None)  # type: ClsType["models.EffectiveNetworkSecurityGroupListResult"]
