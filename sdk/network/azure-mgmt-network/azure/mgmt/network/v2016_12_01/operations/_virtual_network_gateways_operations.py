...
class VirtualNetworkGatewaysOperations(object):
    ...
    def _generatevpnclientpackage_initial(
        ...
        resource_group_name,  # type: str
        virtual_network_gateway_name,  # type: str
        processor_architecture,  # type: Union[str, "models.ProcessorArchitecture"]
        **kwargs  # type: Any
    ):
        # type: (...) -> str
    ...
    def begin_generatevpnclientpackage(
     ...
     and 'X86'.
        :type processor_architecture: str or ~azure.mgmt.network.v2016_12_01.models.ProcessorArchitecture
        :keyword callable cls: A custom type or function that will be passed the direct response
        :keyword polling: True for ARMPolling, False for no polling, or a
         polling object for personal polling strategy
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
