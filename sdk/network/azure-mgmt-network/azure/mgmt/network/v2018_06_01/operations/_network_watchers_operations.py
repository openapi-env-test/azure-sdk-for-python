...
class NetworkWatchersOperations(object):
    ...
    def _get_network_configuration_diagnostic_initial(
        ...
        network_watcher_name,  # type: str
        target_resource_id,  # type: str
        queries,  # type: List["models.TrafficQuery"]
        **kwargs  # type: Any
    ):
        ...
        _parameters = models.NetworkConfigurationDiagnosticParameters(target_resource_id=target_resource_id, queries=queries)
        api_version = "2018-06-01"
        content_type = kwargs.pop("content_type", "application/json")
        ...
        # Construct and send request
        body_content_kwargs = {}  # type: Dict[str, Any]
        body_content = self._serialize.body(_parameters, 'NetworkConfigurationDiagnosticParameters')
        body_content_kwargs['content'] = body_content
        request = self._client.post(url, query_parameters, header_parameters, **body_content_kwargs)
    ...
    def begin_get_network_configuration_diagnostic(
        ...
        **kwargs  # type: Any
        ...
        :param network_watcher_name: The name of the network watcher.
        :type network_watcher_name: str
        :param target_resource_id: The ID of the target resource to perform network configuration
