...
class RecordSetListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.RecordSet"]] = None, next_link: Optional[str] = None, **kwargs):
        """
...
class ZoneListResult(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.Zone"]] = None, next_link: Optional[str] = None, **kwargs):
        """
