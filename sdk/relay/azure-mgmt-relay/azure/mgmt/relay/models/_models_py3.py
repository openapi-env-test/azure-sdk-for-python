...
class NetworkRuleSet(Resource):
    ...
    def __init__(self, *, default_action=None, ip_rules=None, **kwargs) -> None:
...
class PrivateEndpointConnection(TrackedResource):
    ...
    def __init__(self, *, location: str, tags=None, private_endpoint=None, private_link_service_connection_state=None, provisioning_state=None, **kwargs) -> None:
