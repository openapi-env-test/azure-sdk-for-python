...
class ErrorDetails(_serialization.Model):
    ...
    :vartype error: ~azure.mgmt.iothubprovisioningservices.models.ErrorDetailsError
    """
    ...
    def __init__(self, *, error: Optional["_models.ErrorDetailsError"] = None, **kwargs):
        ...
        :paramtype error: ~azure.mgmt.iothubprovisioningservices.models.ErrorDetailsError
        """
        super().__init__(**kwargs)
        self.error = error
...
class Operation(_serialization.Model):
    ...
    def __init__(
        self, *, is_data_action: Optional[bool] = None, display: Optional["_models.OperationDisplay"] = None, **kwargs
    ):
        """
