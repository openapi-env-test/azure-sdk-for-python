...
class NetworkACL(Model):
    ...
    :param allow: Allowed request types. The value can be: ClientConnection,
     ServerConnection, RESTAPI.
    :type allow: list[str]
    :param deny: Denied request types. The value can be: ClientConnection,
     ServerConnection, RESTAPI.
    :type deny: list[str]
    """
...
class SignalRCreateParameters(SignalRUpdateParameters):
    ...
    :type location: str
    :param kind: The kind of the service. (e.g. signalr vs. rawwebsockets).
    ...
    def __init__(self, *, location: str, tags=None, sku=None, properties=None, kind=None, **kwargs) -> None:
...
class SignalRResource(TrackedResource):
    ...
    :ivar kind: The kind of the service - e.g. "SignalR", or "RawWebSockets"
    ...
    def __init__(self, *, location: str=None, tags=None, sku=None, host_name_prefix: str=None, features=None, cors=None, upstream=None, network_ac_ls=None, version: str=None, private_endpoint_connections=None, **kwargs) -> None:
