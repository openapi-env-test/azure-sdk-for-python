...
class SignalROperations:
    ...
    async def check_name_availability(
        ...
        **kwargs
        ...
        :type location: str
        :param type: The resource type. Should be always "Microsoft.SignalRService/SignalR".
        :type type: str
        :param name: The SignalR service name to validate. e.g."my-signalR-name-here".
        :type name: str
        ...
        _parameters = models.NameAvailabilityParameters(type=type, name=name)
        ...
        if _parameters is not None:
            body_content = self._serialize.body(_parameters, 'NameAvailabilityParameters')
        else:
            body_content = None
    ...
    def list_by_subscription(
        self,
        **kwargs
    ) -> AsyncIterable["models.SignalRResourceList"]:
        """Handles requests to list all resources in a subscription.

        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: An iterator like instance of SignalRResourceList or the result of cls(response)
        :rtype: ~azure.core.async_paging.AsyncItemPaged[~azure.mgmt.signalr.models.SignalRResourceList]
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRResourceList"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2018-10-01"
    ...
    async def list_keys(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRKeys"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2018-10-01"
    ...
    async def _regenerate_key_initial(
        ...
        **kwargs
        ...
        _parameters = models.RegenerateKeyParameters(key_type=key_type)
        api_version = "2018-10-01"
        content_type = kwargs.pop("content_type", "application/json")
    ...
    regenerate_key.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/SignalR/{resourceName}/regenerateKey'}  # type: ignore
    ...
    async def get(
        ...
        **kwargs
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
        error_map.update(kwargs.pop('error_map', {}))
        api_version = "2018-10-01"
    ...
    async def _create_or_update_initial(
        ...
        resource_group_name: str,
        resource_name: str,
        parameters: Optional["models.SignalRCreateParameters"] = None,
        **kwargs
    ) -> "models.SignalRResource":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def create_or_update(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}'}  # type: ignore
    ...
    async def delete(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}'}  # type: ignore

    async def _update_initial(
        self,
        resource_group_name: str,
        resource_name: str,
        parameters: Optional["models.SignalRUpdateParameters"] = None,
        **kwargs
    ) -> "models.SignalRResource":
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRResource"]
        error_map = {404: ResourceNotFoundError, 409: ResourceExistsError}
    ...
    async def update(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}'}  # type: ignore
    ...
    async def restart(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    restart.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/signalR/{resourceName}/restart'}  # type: ignore
