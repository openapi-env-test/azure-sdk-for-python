...
from ._configuration_async import SignalRManagementClientConfiguration
from .operations_async import Operations
from .operations_async import SignalROperations
...
class SignalRManagementClient(object):
    ...
    :vartype operations: azure.mgmt.signalr.aio.operations_async.Operations
    :ivar signal_r: SignalROperations operations
    :vartype signal_r: azure.mgmt.signalr.aio.operations_async.SignalROperations
    :ivar usages: UsagesOperations operations
    :vartype usages: azure.mgmt.signalr.aio.operations_async.UsagesOperations
