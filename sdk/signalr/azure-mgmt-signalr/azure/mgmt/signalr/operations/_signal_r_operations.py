...
class SignalROperations(object):
    ...
    def list_by_subscription(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.SignalRResourceList"]
    ...
    def begin_regenerate_key(
     ...
     insensitive).
        ...
        :return: An instance of LROPoller that returns SignalRKeys
    ...
    def _create_or_update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters=None,  # type: Optional["models.SignalRCreateParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SignalRResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRResource"]
    ...
    def begin_create_or_update(
     ...
     obtain this value from the Azure Resource Manager API or the portal.
        ...
        :paramtype polling: bool or ~azure.core.polling.PollingMethod
        :keyword int polling_interval: Default waiting time between two polls for LRO operations if no Retry-After header is present.
        :return: An instance of LROPoller that returns SignalRResource
    ...
    def _update_initial(
        ...
        resource_group_name,  # type: str
        resource_name,  # type: str
        parameters=None,  # type: Optional["models.SignalRUpdateParameters"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.SignalRResource"
        cls = kwargs.pop('cls', None)  # type: ClsType["models.SignalRResource"]
