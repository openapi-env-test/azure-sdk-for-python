...
from ._models_py3 import SupportTicketResourceIdLookUpResponse
from ._models_py3 import SupportTicketResourceIdLookupRequest
...
__all__ = [
    ...
    "SupportTicketResourceIdLookUpResponse",
