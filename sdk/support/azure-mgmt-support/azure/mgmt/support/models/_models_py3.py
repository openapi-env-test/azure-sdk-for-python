...
class SupportTicketResourceIdLookupRequest(_serialization.Model):
    """The Support ticket resource Id look up request.

    :ivar support_ticket_id: The Support Ticket Id.
    :vartype support_ticket_id: str
    """

    _attribute_map = {
        "support_ticket_id": {"key": "supportTicketId", "type": "str"},
    }

    def __init__(self, *, support_ticket_id: Optional[str] = None, **kwargs):
        """
        :keyword support_ticket_id: The Support Ticket Id.
        :paramtype support_ticket_id: str
        """
        super().__init__(**kwargs)
        self.support_ticket_id = support_ticket_id
...
class SupportTicketResourceIdLookUpResponse(_serialization.Model):
    """The Support ticket resource id look up response.

    :ivar resource_id: The ARM resource Id of support ticket.
    ...
    def __init__(self, *, resource_id: Optional[str] = None, **kwargs):
        """
        :keyword resource_id: The ARM resource Id of support ticket.
