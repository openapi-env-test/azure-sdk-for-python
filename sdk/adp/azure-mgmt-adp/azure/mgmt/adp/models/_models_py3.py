...
class AccountCheckNameAvailabilityParameters(msrest.serialization.Model):
    ...
    :ivar name: Required. The account name.
    :vartype name: str
    :ivar type: Required. The type of resource, Microsoft.AutonomousDevelopmentPlatform/accounts.
     Known values are: "Microsoft.AutonomousDevelopmentPlatform/accounts".
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. The account name.
        :paramtype name: str
        :keyword type: Required. The type of resource,
         Microsoft.AutonomousDevelopmentPlatform/accounts. Known values are:
...
class CheckNameAvailabilityResult(msrest.serialization.Model):
    ...
    :ivar reason: Gets the reason that an account name could not be used. The reason element is
     only returned if nameAvailable is false. Known values are: "Invalid", "AlreadyExists".
...
class DataPool(Resource):
    ...
    :ivar provisioning_state: Gets the status of the data pool at the time the operation was
     called. Known values are: "Succeeded", "Failed", "Canceled", "Accepted", "Provisioning",
     "Deleting".
    :vartype provisioning_state: str or ~azure.mgmt.adp.models.ProvisioningState
...
class DataPoolEncryption(msrest.serialization.Model):
    ...
    :ivar key_vault_uri: Required. The URI of a soft delete-enabled Key Vault that is in the same
     location as the Data Pool location.
    :vartype key_vault_uri: str
    :ivar key_name: Required. The name of Key Vault key.
    :vartype key_name: str
    :ivar key_version: The version of Key Vault key.
    :vartype key_version: str
    :ivar user_assigned_identity: Required. The resource ID of a user-assigned Managed Identity
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword key_vault_uri: Required. The URI of a soft delete-enabled Key Vault that is in the
         same location as the Data Pool location.
        :paramtype key_vault_uri: str
        :keyword key_name: Required. The name of Key Vault key.
        :paramtype key_name: str
        :keyword key_version: The version of Key Vault key.
        :paramtype key_version: str
        :keyword user_assigned_identity: Required. The resource ID of a user-assigned Managed Identity
         used to access the encryption key in the Key Vault. Requires access to the key operations get,
         wrap, unwrap, and recover.
...
class DataPoolLocation(msrest.serialization.Model):
    ...
    :ivar name: Required. The location name.
    :vartype name: str
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword name: Required. The location name.
        :paramtype name: str
...
class StorageSku(msrest.serialization.Model):
    ...
    :ivar name: Required. The SKU name. Known values are: "Standard_LRS", "Standard_GRS",
    ...
    def __init__(
        self,
        *,
        name: Union[str, "_models.StorageSkuName"],
        **kwargs
    ):
        """
        :keyword name: Required. The SKU name. Known values are: "Standard_LRS", "Standard_GRS",
         "Standard_Ragrs", "Standard_ZRS", "Premium_LRS", "Premium_ZRS", "Standard_Gzrs",
         "Standard_Ragzrs".
