...
class ContainerRegistryManagementClient(MultiApiClientMixin, SDKClient):
    ...
    def models(cls, api_version=DEFAULT_API_VERSION):
        """Module depends on the API version:
           ...
           * 2019-12-01-preview: :mod:`v2020_11_01_preview.models<azure.mgmt.containerregistry.v2020_11_01_preview.models>`
        """
    ...
    def export_pipelines(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`ExportPipelinesOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.ExportPipelinesOperations>`
        """
    ...
    def import_pipelines(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`ImportPipelinesOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.ImportPipelinesOperations>`
        """
    ...
    def operations(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`Operations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.Operations>`
        """
    ...
    def pipeline_runs(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`PipelineRunsOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.PipelineRunsOperations>`
        """
    ...
    def private_endpoint_connections(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`PrivateEndpointConnectionsOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.PrivateEndpointConnectionsOperations>`
        """
    ...
    def registries(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`RegistriesOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.RegistriesOperations>`
        """
    ...
    def replications(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`ReplicationsOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.ReplicationsOperations>`
        """
    ...
    def webhooks(self):
        """Instance depends on the API version:
           ...
           * 2019-12-01-preview: :class:`WebhooksOperations<azure.mgmt.containerregistry.v2020_11_01_preview.operations.WebhooksOperations>`
        """
