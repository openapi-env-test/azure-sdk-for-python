...
class PipelineRunRequest(Model):
    ...
    def __init__(self, *, pipeline_resource_id: str=None, artifacts=None, source=None, target=None, catalog_digest: str=None, is_archive_enabled: bool=True, **kwargs) -> None:
...
class PipelineRunResponse(Model):
    ...
    def __init__(self, *, status: str=None, imported_artifacts=None, progress=None, start_time=None, finish_time=None, source=None, target=None, catalog_digest: str=None, trigger=None, pipeline_run_error_message: str=None, is_archive_enabled: bool=None, **kwargs) -> None:
