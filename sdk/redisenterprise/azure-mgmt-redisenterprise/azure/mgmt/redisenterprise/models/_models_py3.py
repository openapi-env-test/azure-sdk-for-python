...
class Capability(_serialization.Model):
    ...
    def __init__(self, *, name: Optional[str] = None, value: Optional[bool] = None, **kwargs):
        """
...
class LocationInfo(_serialization.Model):
    ...
    def __init__(
        self, *, location: Optional[str] = None, capabilities: Optional[List["_models.Capability"]] = None, **kwargs
    ):
        """
...
class RegionSkuDetails(_serialization.Model):
    ...
    def __init__(self, *, value: Optional[List["_models.RegionSkuDetail"]] = None, **kwargs):
        """
