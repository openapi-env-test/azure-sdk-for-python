...
class AlertRuleTemplatesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.contoso.mgmt.securityinsight.models.AlertRuleTemplatePaged[~azure.contoso.mgmt.securityinsight.models.AlertRuleTemplate]
    ...
    def get(
        ...
        :rtype: ~azure.contoso.mgmt.securityinsight.models.AlertRuleTemplate
