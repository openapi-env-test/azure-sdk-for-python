...
class ThreatIntelligenceIndicatorMetricsOperations(object):
    ...
    def list(
        ...
        :return: ThreatIntelligenceMetricsList or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.contoso.mgmt.securityinsight.models.ThreatIntelligenceMetricsList
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ThreatIntelligenceMetricsList', response)
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{operationalInsightsResourceProvider}/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/threatIntelligence/main/metrics'}
