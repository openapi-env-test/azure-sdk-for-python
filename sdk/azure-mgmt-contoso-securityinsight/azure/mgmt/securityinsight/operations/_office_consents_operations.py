...
class OfficeConsentsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.contoso.mgmt.securityinsight.models.OfficeConsentPaged[~azure.contoso.mgmt.securityinsight.models.OfficeConsent]
    ...
    def get(
        ...
        :rtype: ~azure.contoso.mgmt.securityinsight.models.OfficeConsent or
