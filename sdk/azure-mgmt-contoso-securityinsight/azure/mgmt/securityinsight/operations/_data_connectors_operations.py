...
class DataConnectorsOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.contoso.mgmt.securityinsight.models.DataConnectorPaged[~azure.contoso.mgmt.securityinsight.models.DataConnector]
    ...
    def get(
        ...
        :rtype: ~azure.contoso.mgmt.securityinsight.models.DataConnector or
    ...
    def create_or_update(
        ...
        :type data_connector:
         ~azure.contoso.mgmt.securityinsight.models.DataConnector
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
