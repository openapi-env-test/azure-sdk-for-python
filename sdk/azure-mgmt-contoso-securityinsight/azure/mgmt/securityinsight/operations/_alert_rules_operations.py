...
class AlertRulesOperations(object):
    ...
    def list(
        ...
        :rtype:
         ~azure.contoso.mgmt.securityinsight.models.AlertRulePaged[~azure.contoso.mgmt.securityinsight.models.AlertRule]
    ...
    def get(
        ...
        :rtype: ~azure.contoso.mgmt.securityinsight.models.AlertRule or
    ...
    def create_or_update(
        ...
        :type alert_rule: ~azure.contoso.mgmt.securityinsight.models.AlertRule
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
