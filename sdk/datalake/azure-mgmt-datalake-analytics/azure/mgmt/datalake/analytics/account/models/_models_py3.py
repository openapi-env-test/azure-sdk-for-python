...
class DataLakeAnalyticsAccount(Resource):
    ...
    :param public_data_lake_store_accounts: The list of Data Lake Store
     accounts associated with this account.
    :type public_data_lake_store_accounts:
     list[~azure.mgmt.datalake.analytics.account.models.DataLakeStoreAccountInformation]
    ...
    def __init__(self, *, public_data_lake_store_accounts=None, firewall_state=None, firewall_allow_azure_ips=None, new_tier=None, max_job_count: int=3, max_degree_of_parallelism: int=30, max_degree_of_parallelism_per_job: int=None, query_store_retention: int=30, **kwargs) -> None:
...
class OperationMetaMetricSpecification(Model):
    ...
    :type name: str
    :param display_description: The displayName for
     OperationMetaMetricSpecification.
    ...
    def __init__(self, *, name: str=None, display_description: str=None, display_name: str=None, unit: str=None, aggregation_type: str=None, availabilities=None, **kwargs) -> None:
