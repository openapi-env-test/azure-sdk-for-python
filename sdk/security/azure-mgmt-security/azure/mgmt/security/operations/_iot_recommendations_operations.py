...
class IotRecommendationsOperations(object):
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/{scope}/providers/Microsoft.Security/iotRecommendations'}
    ...
    def get(
        ...
        return deserialized
    get.metadata = {'url': '/{scope}/providers/Microsoft.Security/iotRecommendations/{iotRecommendationId}'}
