...
class IotAlertTypesOperations(object):
    ...
    def list(
        ...
        return deserialized
    list.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/iotAlertTypes'}

    def get(
            self, iot_alert_type_name, custom_headers=None, raw=False, **operation_config):
        """Get IoT alert type.
        ...
        return deserialized
    get.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Security/iotAlertTypes/{iotAlertTypeName}'}
