...
class Setting(Resource):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: DataExportSettings, AlertSyncSettings
    ...
    _subtype_map = {
        'kind': {'DataExportSettings': 'DataExportSettings', 'AlertSyncSettings': 'AlertSyncSettings'}
    }
...
class AlertSyncSettings(Setting):
    ...
    :param kind: Required. Constant filled by server.
    :type kind: str
    :param enabled: Required. Is the alert sync setting enabled
    :type enabled: bool
    """
...
class DataExportSettings(Setting):
    ...
    :param kind: Required. Constant filled by server.
    :type kind: str
    :param enabled: Required. Is the data export setting enabled
    :type enabled: bool
    """
...
class IngestionConnectionString(Model):
    """Connection string for ingesting security data and logs.
...
class IngestionSettingToken(Model):
    """Configures how to correlate scan data and logs with resources associated
    with the subscription.
    ...
    :ivar token: The token is used for correlating security data and logs with
...
class IotDefenderSettingsModel(Resource):
    ...
    :param onboarding_kind: Required. The kind of onboarding for the
     subscription. Possible values include: 'Default', 'MigratedToAzure',
     'Evaluation', 'Purchased'
    :type onboarding_kind: str or ~azure.mgmt.security.models.OnboardingKind
    :ivar evaluation_end_time: End time of the evaluation period, if such
     exist
    :vartype evaluation_end_time: datetime
    """
    ...
    _attribute_map = {
        ...
        'evaluation_end_time': {'key': 'properties.evaluationEndTime', 'type': 'iso-8601'},
    }

    def __init__(self, *, device_quota: int, sentinel_workspace_resource_ids, onboarding_kind, **kwargs) -> None:
...
class IotSensorsModel(Resource):
    ...
    :type zone: str
    :param sensor_type: Type of sensor. Possible values include: 'Ot',
     'Enterprise'
    ...
    def __init__(self, *, ti_automatic_updates: bool=None, zone: str=None, sensor_type=None, **kwargs) -> None:
...
class SecurityAssessmentMetadata(Resource):
    ...
    def __init__(self, *, display_name: str, severity, assessment_type, description: str=None, remediation_description: str=None, categories=None, user_impact=None, implementation_effort=None, threats=None, preview: bool=None, partner_data=None, **kwargs) -> None:
...
class Software(Resource):
    ...
    :ivar type: Resource type
    :vartype type: str
    :param device_id: Unique identifier for the virtual machine in the
     service.
    :type device_id: str
    :param os_platform: Platform of the operating system running on the
     device.
    ...
    :type version: str
    :param end_of_support_status: End of support status. Possible values
     include: 'None', 'noLongerSupported', 'versionNoLongerSupported',
     'upcomingNoLongerSupported', 'upcomingVersionNoLongerSupported'
    :type end_of_support_status: str or
     ~azure.mgmt.security.models.EndOfSupportStatus
    :param end_of_support_date: The end of support date in case the product is
    ...
    def __init__(self, *, device_id: str=None, os_platform: str=None, vendor: str=None, software_name: str=None, version: str=None, end_of_support_status=None, end_of_support_date: str=None, number_of_known_vulnerabilities: int=None, first_seen_at: str=None, **kwargs) -> None:
