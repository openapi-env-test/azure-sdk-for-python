...
class Alert(Resource):
    ...
    :ivar severity: The risk level of the threat that was detected. Possible
    ...
    :ivar resource_identifiers: The resource identifiers for this alert which
     can be used to direct the alert to the right product exposure group
     (tenant, workspace, subscription etc.). There can be multiple identifiers
     of different type per alert.
    ...
    :ivar status: The life cycle status of the alert. Supported statuses are:
    ...
    :vartype extended_links: list[dict[str, object]]
    :ivar alert_uri: A direct link to the alert page in Azure Portal.
    :vartype alert_uri: str
    :ivar time_generated: The UTC time the alert was generated in ISO8601
     format.
    ...
    :ivar processing_end_time: The UTC processing end time of the alert in
     ISO8601 format.
    ...
    _attribute_map = {
        ...
        'extended_links': {'key': 'properties.extendedLinks', 'type': '[{object}]'},
    ...
    def __init__(self, *, additional_properties=None, extended_properties=None, **kwargs) -> None:
...
class AzureResourceIdentifier(ResourceIdentifier):
    ...
    def __init__(self, *, additional_properties=None, **kwargs) -> None:
        super(AzureResourceIdentifier, self).__init__(additional_properties=additional_properties, **kwargs)
...
class LogAnalyticsIdentifier(ResourceIdentifier):
    ...
    def __init__(self, *, additional_properties=None, **kwargs) -> None:
        super(LogAnalyticsIdentifier, self).__init__(additional_properties=additional_properties, **kwargs)
