...
class SecurityAssessmentMetadataPropertiesResponse(SecurityAssessmentMetadataProperties):  # pylint: disable=too-many-instance-attributes
...
class SecurityAssessmentProperties(SecurityAssessmentPropertiesBase):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :paramtype status: ~azure.mgmt.security.v2021_06_01.models.AssessmentStatus
        """
        super().__init__(resource_details=resource_details, additional_data=additional_data, metadata=metadata, partners_data=partners_data, **kwargs)
        self.status = status
