...
class AnomalyDetectorClientOperationsMixin(object):
    ...
    def breaking_change_detect_entire_series(
        ...
        """
        # Construct URL
        url = self.breaking_change_detect_entire_series.metadata['url']
        ...
        return deserialized
    breaking_change_detect_entire_series.metadata = {'url': '/timeseries/entire/detect'}
