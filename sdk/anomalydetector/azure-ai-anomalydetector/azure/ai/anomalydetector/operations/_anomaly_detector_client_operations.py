...
class AnomalyDetectorClientOperationsMixin(object):
    ...
    def shivangi_test_detect_entire_series(
            self, body, custom_headers=None, raw=False, **operation_config):
        """Detect anomalies for the entire series in batch.

        Testing This operation generates a model using an entire series, each
        point is detected with the same model. With this method, points before
        ...
        """
        # Construct URL
        url = self.shivangi_test_detect_entire_series.metadata['url']
        ...
        return deserialized
    shivangi_test_detect_entire_series.metadata = {'url': '/timeseries/entire/detect'}
