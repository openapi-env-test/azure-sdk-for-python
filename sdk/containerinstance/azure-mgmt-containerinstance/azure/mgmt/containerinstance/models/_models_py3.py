...
class Components10Wh5UdSchemasContainergroupidentityPropertiesUserassignedidentitiesAdditionalproperties(
...
class ContainerGroup(Resource):  # pylint: disable=too-many-instance-attributes
    """A container group.
    ...
    :ivar priority: The container group priority for provisioning containers. Known values are:
     "Regular" and "Spot".
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword priority: The container group priority for provisioning containers. Known values are:
         "Regular" and "Spot".
    ...
    def __init__(
        ...
        *,
        ...
        user_assigned_identities: Optional[
            Dict[
                str,
                "_models.Components10Wh5UdSchemasContainergroupidentityPropertiesUserassignedidentitiesAdditionalproperties",
            ]
        ] = None,
        **kwargs
    ):
...
class ImageRegistryCredential(_serialization.Model):
    ...
    :ivar server: The Docker image registry server without a protocol such as "http" and "https".
     Required.
    :vartype server: str
    :ivar username: The username for the private registry. Required.
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword username: The username for the private registry. Required.
...
class IpAddress(_serialization.Model):
    ...
    def __init__(
        ...
        *,
        ...
        dns_name_label_reuse_policy: Optional[Union[str, "_models.DnsNameLabelReusePolicy"]] = None,
        **kwargs
    ):
        """
        ...
        :keyword dns_name_label_reuse_policy: The value representing the security enum. Known values
         are: "Unsecure", "TenantReuse", "SubscriptionReuse", "ResourceGroupReuse", and "Noreuse".
