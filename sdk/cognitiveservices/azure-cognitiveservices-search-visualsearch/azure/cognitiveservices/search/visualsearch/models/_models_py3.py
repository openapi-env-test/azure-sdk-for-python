...
class CreativeWork(Thing):
    ...
    You probably want to use the sub-classes and not this class directly. Known
    sub-classes are: Action, MediaObject, Recipe, License
    ...
    :ivar main_entity:
    :vartype main_entity:
     ~azure.cognitiveservices.search.visualsearch.models.Thing
    """
    ...
    _subtype_map = {
        '_type': {'Action': 'Action', 'MediaObject': 'MediaObject', 'Recipe': 'Recipe', 'License': 'License'}
    }
...
class ImageEntityAction(ImageAction):
    ...
    :ivar is_translated: Indicates whether entity name or description is
     translated or not. Only set to true when translated.
    :vartype is_translated: bool
    """
    ...
    _attribute_map = {
        ...
        'is_translated': {'key': 'isTranslated', 'type': 'bool'},
    }
