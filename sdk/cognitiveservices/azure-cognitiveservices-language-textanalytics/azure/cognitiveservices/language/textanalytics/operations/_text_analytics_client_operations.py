...
class TextAnalyticsClientOperationsMixin(object):
    ...
    def breaking_change_entities_recognition_general(
        ...
        Test The API returns a list of general named entities in a given
        document. For the list of supported entity types, check <a
        ...
        # Construct URL
        url = self.breaking_change_entities_recognition_general.metadata['url']
        path_format_arguments = {
            'Endpoint': self._serialize.url("self.config.endpoint", self.config.endpoint, 'str', skip_quote=True)
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    breaking_change_entities_recognition_general.metadata = {'url': '/entities/recognition/general'}
