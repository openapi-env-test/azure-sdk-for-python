...
class IpConfiguration(_serialization.Model):
    ...
    :ivar private_ip_allocation_method: Private IP address allocation method. "Dynamic"
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword private_ip_allocation_method: Private IP address allocation method. "Dynamic"
