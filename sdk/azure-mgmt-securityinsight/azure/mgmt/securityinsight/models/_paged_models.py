...
class RelationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Relation <azure.mgmt.securityinsight.models.Relation>` object
    """
...
class WatchlistPaged(Paged):
    """
    A paging container for iterating over a list of :class:`Watchlist <azure.mgmt.securityinsight.models.Watchlist>` object
    """
...
class ThreatIntelligenceInformationPaged(Paged):
    """
    A paging container for iterating over a list of :class:`ThreatIntelligenceInformation <azure.mgmt.securityinsight.models.ThreatIntelligenceInformation>` object
    """
