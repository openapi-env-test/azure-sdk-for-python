...
class DataConnector(ResourceWithEtag, DataConnectorKind):
    """Data connector.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DataConnector, self).__init__(etag=etag, kind=kind, **kwargs)
        self.kind = kind
        self.id = None
        self.name = None
        self.type = None
...
class AADDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AADDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
...
class AATPDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AATPDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
        self.tenant_id = tenant_id
        self.data_types = data_types
...
class AlertRule(ResourceWithEtag, AlertRuleKind):
    """Alert rule.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AlertRule, self).__init__(etag=etag, kind=kind, **kwargs)
        self.kind = kind
        self.id = None
        self.name = None
        self.type = None
...
class AlertRuleTemplate(AlertRuleKind, Resource):
    """Alert rule template.
...
class ASCDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ASCDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
        self.data_types = data_types
...
class AwsCloudTrailDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AwsCloudTrailDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
...
class FusionAlertRule(AlertRule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FusionAlertRule, self).__init__(kind=kind, etag=etag, **kwargs)
...
class MCASDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MCASDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
        self.tenant_id = tenant_id
        self.data_types = data_types
...
class MDATPDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MDATPDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
        self.tenant_id = tenant_id
        self.data_types = data_types
...
class MicrosoftSecurityIncidentCreationAlertRule(AlertRule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(MicrosoftSecurityIncidentCreationAlertRule, self).__init__(kind=kind, etag=etag, **kwargs)
...
class OfficeDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(OfficeDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
        self.tenant_id = tenant_id
        self.data_types = data_types
...
class ScheduledAlertRuleTemplateProperties(AlertRuleTemplatePropertiesBase, ScheduledAlertRuleCommonProperties):
...
class Settings(ResourceWithEtag, SettingsKind):
    """The Setting.
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Settings, self).__init__(etag=etag, kind=kind, **kwargs)
        self.kind = kind
        self.id = None
        self.name = None
        self.type = None
...
class TIDataConnector(DataConnector):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TIDataConnector, self).__init__(kind=kind, etag=etag, **kwargs)
        self.tenant_id = tenant_id
        self.data_types = data_types
...
class ToggleSettings(Settings):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ToggleSettings, self).__init__(kind=kind, etag=etag, **kwargs)
...
class UebaSettings(Settings):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(UebaSettings, self).__init__(kind=kind, etag=etag, **kwargs)
