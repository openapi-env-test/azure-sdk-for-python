...
class IncidentCommentsOperations:
    ...
    def list_by_incident(
     ...
     a skiptoken parameter that specifies a starting point to use for subsequent calls. Optional.
        ...
        :return: An iterator like instance of IncidentCommentList or the result of cls(response)
    ...
    async def get_comment(
        ...
        **kwargs
        ...
        # Construct URL
        url = self.get_comment.metadata['url']  # type: ignore
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self._config.subscription_id", self._config.subscription_id, 'str', pattern=r'^[0-9A-Fa-f]{8}-([0-9A-Fa-f]{4}-){3}[0-9A-Fa-f]{12}$'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str', max_length=90, min_length=1, pattern=r'^[-\w\._\(\)]+$'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str', max_length=90, min_length=1),
        ...
        return deserialized
    get_comment.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/providers/Microsoft.SecurityInsights/incidents/{incidentId}/comments/{incidentCommentId}'}  # type: ignore
