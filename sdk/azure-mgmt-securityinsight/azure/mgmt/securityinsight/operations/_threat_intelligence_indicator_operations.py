...
class ThreatIntelligenceIndicatorOperations(object):
    ...
    def create_indicator(
        ...
        :return: ThreatIntelligenceInformation or ClientRawResponse if
         raw=true
        :rtype:
         ~azure.mgmt.securityinsight.models.ThreatIntelligenceInformation or
    ...
    def query_indicators(
        ...
        :rtype:
         ~azure.mgmt.securityinsight.models.ThreatIntelligenceInformationPaged[~azure.mgmt.securityinsight.models.ThreatIntelligenceInformation]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
